...
-functions([
 ...
 {{qname, ?NS, ?PX, <<"spawn">>}, 
  {seqType, 'xs:base64Binary', one}, [{annotation,{qname, ?XL, <<>>, ?ND},[]}], 
  {'spawn_', 2}, 1, 
  [{seqType, {funTest,function,[],{qname, ?NS, ?PX, <<"spawn">>},[],{seqType, item, zero_or_many}}, one}]},
 {{qname, ?NS, ?PX, <<"parent">>}, 
  {seqType, 'xs:base64Binary', zero_or_one}, [{annotation,{qname, ?XL, <<>>, ?ND},[]}], 
  {'parent', 1}, 0, 
  []},
 {{qname, ?NS, ?PX, <<"self">>}, 
  {seqType, 'xs:base64Binary', one}, [{annotation,{qname, ?XL, <<>>, ?ND},[]}], 
