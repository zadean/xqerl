...
-functions([
 {{qname,?NS, ?PX, <<"acos">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'acos', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"asin">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'asin', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"atan">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'atan', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"atan2">>}, 
  {seqType, 'xs:double', one}, [], {'atan2', 3}, 2, [{seqType, 'xs:double', one},{seqType, 'xs:double', one}]},
 {{qname, ?NS,?PX, <<"cos">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'cos', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"exp">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'exp', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"exp10">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'exp10', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"log">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'log', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"log10">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'log10', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"pi">>}, 
  {seqType, 'xs:double', one}, [], {'pi', 1}, 0, []},
 {{qname, ?NS,?PX, <<"pow">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'pow', 3}, 2, [{seqType, 'xs:double', zero_or_one},{seqType, 'xs:numeric', one}]},
 {{qname, ?NS,?PX, <<"sin">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'sin', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"sqrt">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'sqrt', 2}, 1, [{seqType, 'xs:double', zero_or_one}]},
 {{qname, ?NS,?PX, <<"tan">>}, 
  {seqType, 'xs:double', zero_or_one}, [], {'tan', 2}, 1, [{seqType, 'xs:double', zero_or_one}]}]).
