...
-functions([
%% 5 Defining 'constants' and conversions
{{qname, ?NS, ?PX, <<"hex">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {hex, 2}, 1, [{seqType, 'xs:string', zero_or_one}]},
{{qname, ?NS, ?PX, <<"bin">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {bin, 2}, 1, [{seqType, 'xs:string', zero_or_one}]},
{{qname, ?NS, ?PX, <<"octal">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {octal, 2}, 1, [{seqType, 'xs:string', zero_or_one}]},
{{qname, ?NS, ?PX, <<"to-octets">>}, {seqType, 'xs:integer', zero_or_many}, [], 
 {to_octets, 2}, 1, [{seqType, 'xs:base64Binary', one}]},
{{qname, ?NS, ?PX, <<"from-octets">>}, {seqType, 'xs:base64Binary', one}, [], 
 {from_octets, 2}, 1, [{seqType, 'xs:integer', zero_or_many}]},
%% 6 Basic operations
{{qname, ?NS, ?PX, <<"length">>}, {seqType, 'xs:integer', one}, [], 
 {length, 2}, 1, [{seqType, 'xs:base64Binary', one}]},
{{qname, ?NS, ?PX, <<"part">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {part, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"part">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {part, 4}, 3, [{seqType, 'xs:base64Binary', zero_or_one},
                {seqType, 'xs:integer', one},
                {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"join">>}, {seqType, 'xs:base64Binary', one}, [], 
 {join, 2}, 1, [{seqType, 'xs:base64Binary', zero_or_many}]},
{{qname, ?NS, ?PX, <<"insert-before">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {insert_before, 4}, 3, [{seqType, 'xs:base64Binary', zero_or_one},
                         {seqType, 'xs:integer', one},
                         {seqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"pad-left">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_left, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                    {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pad-left">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_left, 4}, 3, [{seqType, 'xs:base64Binary', zero_or_one},
                    {seqType, 'xs:integer', one},
                    {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pad-right">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_right, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                     {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pad-right">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_right, 4}, 3, [{seqType, 'xs:base64Binary', zero_or_one},
                     {seqType, 'xs:integer', one},
                     {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"find">>}, {seqType, 'xs:integer', zero_or_one}, [], 
 {find, 4}, 3, [{seqType, 'xs:base64Binary', zero_or_one},
                {seqType, 'xs:integer', one},
...
{{qname, ?NS, ?PX, <<"decode-string">>}, {seqType, 'xs:string', zero_or_one}, [], 
 {decode_string, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                         {seqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"decode-string">>}, {seqType, 'xs:string', zero_or_one}, [], 
 {decode_string, 4}, 3, [{seqType, 'xs:base64Binary', zero_or_one},
                         {seqType, 'xs:string', one},
                         {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"decode-string">>}, {seqType, 'xs:string', zero_or_one}, [], 
 {decode_string, 5}, 4, [{seqType, 'xs:base64Binary', zero_or_one},
                         {seqType, 'xs:string', one},
                         {seqType, 'xs:integer', one},
                         {seqType, 'xs:integer', one}]},
...
{{qname, ?NS, ?PX, <<"encode-string">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {encode_string, 3}, 2, [{seqType, 'xs:string', zero_or_one},
                         {seqType, 'xs:string', one}]},
%% 8 Packing and unpacking of encoded numeric values
{{qname, ?NS, ?PX, <<"pack-double">>}, {seqType, 'xs:base64Binary', one}, [], 
 {pack_double, 2}, 1, [{seqType, 'xs:double', one}]},
{{qname, ?NS, ?PX, <<"pack-double">>}, {seqType, 'xs:base64Binary', one}, [], 
 {pack_double, 3}, 2, [{seqType, 'xs:double', one},
                       {seqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"pack-float">>}, {seqType, 'xs:base64Binary', one}, [], 
 {pack_float, 2}, 1, [{seqType, 'xs:float', one}]},
{{qname, ?NS, ?PX, <<"pack-float">>}, {seqType, 'xs:base64Binary', one}, [], 
 {pack_float, 3}, 2, [{seqType, 'xs:float', one},
                      {seqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"pack-integer">>}, {seqType, 'xs:base64Binary', one}, [], 
 {pack_integer, 3}, 2, [{seqType, 'xs:integer', one},
                        {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pack-integer">>}, {seqType, 'xs:base64Binary', one}, [], 
 {pack_integer, 4}, 3, [{seqType, 'xs:integer', one},
                        {seqType, 'xs:integer', one},
                        {seqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-double">>}, {seqType, 'xs:double', zero_or_one}, [], 
 {unpack_double, 3}, 2, [{seqType, 'xs:base64Binary', one},
                         {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-double">>}, {seqType, 'xs:double', zero_or_one}, [], 
 {unpack_double, 4}, 3, [{seqType, 'xs:base64Binary', one},
                         {seqType, 'xs:integer', one},
                         {seqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-float">>}, {seqType, 'xs:float', one}, [], 
 {unpack_float, 3}, 2, [{seqType, 'xs:base64Binary', one},
                        {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-float">>}, {seqType, 'xs:float', one}, [], 
 {unpack_float, 4}, 3, [{seqType, 'xs:base64Binary', one},
                        {seqType, 'xs:integer', one},
                        {seqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-integer">>}, {seqType, 'xs:integer', one}, [], 
 {unpack_integer, 4}, 3, [{seqType, 'xs:base64Binary', one},
                          {seqType, 'xs:integer', one},
                          {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-integer">>}, {seqType, 'xs:integer', one}, [], 
 {unpack_integer, 5}, 4, [{seqType, 'xs:base64Binary', one},
                          {seqType, 'xs:integer', one},
                          {seqType, 'xs:integer', one},
                          {seqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-unsigned-integer">>}, {seqType, 'xs:integer', one}, [], 
 {unpack_unsigned_integer, 4}, 3, [{seqType, 'xs:base64Binary', one},
                                   {seqType, 'xs:integer', one},
                                   {seqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-unsigned-integer">>}, {seqType, 'xs:integer', one}, [], 
 {unpack_unsigned_integer, 5}, 4, [{seqType, 'xs:base64Binary', one},
                                   {seqType, 'xs:integer', one},
                                   {seqType, 'xs:integer', one},
                                   {seqType, 'xs:string', one}]},
%% 9 Bitwise operations
{{qname, ?NS, ?PX, <<"or">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {or_, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                {seqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"xor">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {xor_, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                 {seqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"and">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {and_, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                 {seqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"not">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {not_, 2}, 1, [{seqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"shift">>}, {seqType, 'xs:base64Binary', zero_or_one}, [], 
 {shift, 3}, 2, [{seqType, 'xs:base64Binary', zero_or_one},
                 {seqType, 'xs:integer', one}]}
]).
