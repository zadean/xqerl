...
main(Options) ->
    ...
    xqerl_types:return_value(xqerl_operators:lookup(Ctx,
                      xqerl_fn:sort(Ctx,
                          xqerl_seq3:flatten([xqerl_map:construct(Ctx,
                          ...
                          {xqFunction, undefined, undefined, undefined, 1,
                           ...
                           fun (Ctx__1, Param__var_1) ->
                              xqerl_types:cast_as_seq(xqerl_map:get(Ctx__1, Param__var_1,
                                           {xqAtomicValue,
                                            'xs:string', "key"}),
                                       {xqSeqType, 'xs:anyAtomicType',
                                        zero_or_many})
                           end}),
                      {xqAtomicValue, 'xs:NCName', "value"})).