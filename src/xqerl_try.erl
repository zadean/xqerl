...
main(Options) ->
    ...
    xqerl_types:return_value(
      xqerl_operators:subtract(
        {xqAtomicValue, 'xs:integer', 3},
        xqerl_node:new_fragment(
          Ctx,
          {xqElementNode, undefined, undefined,
                                  {qname, 'no-namespace', [], "a"}, undefined, [], [],
                                  [{xqNamespace, 'no-namespace', []}], undefined, 'xs:anyType',
                                  [], undefined,
                                  [{xqElementNode, undefined, undefined,
                               {qname, 'no-namespace', [], "b"}, undefined, [], [],
                               [{xqNamespace, 'no-namespace', []}], undefined,
                               'xs:anyType', [], undefined,
                               {xqTextNode, undefined, undefined, false, undefined,
                                {xqAtomicValue, 'xs:string', "2"}}},
                              {xqElementNode, undefined, undefined,
                               {qname, 'no-namespace', [], "c"}, undefined, [], [],
                               [{xqNamespace, 'no-namespace', []}], undefined,
                               'xs:anyType', [], undefined,
                               {xqTextNode, undefined, undefined, false, undefined,
                                {xqAtomicValue, 'xs:string', "2"}}}]}))).