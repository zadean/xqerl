...
init() ->
    ...
    xqerl_context:set_named_functions(Tab,
                  [{{qname, "sudoku", "fn", "getRow"}, {xqSeqType, 'xs:integer', one_or_many}, [],
               {xqerl_main, '__Q{sudoku}getRow', 3}, 2,
               [{xqSeqType, 'xs:integer', one_or_many}, {xqSeqType, 'xs:integer', one}]},
                   {{qname, "sudoku", "fn", "getCol"}, {xqSeqType, 'xs:integer', one_or_many}, [],
               {xqerl_main, '__Q{sudoku}getCol', 3}, 2,
               [{xqSeqType, 'xs:integer', one_or_many}, {xqSeqType, 'xs:integer', one}]},
                   {{qname, "sudoku", "fn", "getGroup"}, {xqSeqType, 'xs:integer', one_or_many},
               [], {xqerl_main, '__Q{sudoku}getGroup', 3}, 2,
               [{xqSeqType, 'xs:integer', one_or_many}, {xqSeqType, 'xs:integer', one}]},
                   {{qname, "sudoku", "fn", "getAllowedValues"},
               {xqSeqType, 'xs:integer', zero_or_many}, [],
               {xqerl_main, '__Q{sudoku}getAllowedValues', 3}, 2,
               [{xqSeqType, 'xs:integer', one_or_many}, {xqSeqType, 'xs:integer', one}]},
                   {{qname, "sudoku", "fn", "tryValues"}, {xqSeqType, 'xs:integer', zero_or_many},
               [], {xqerl_main, '__Q{sudoku}tryValues', 4}, 3,
               [{xqSeqType, 'xs:integer', one_or_many}, {xqSeqType, 'xs:integer', one_or_many},
                {xqSeqType, 'xs:integer', one_or_many}]},
                   {{qname, "sudoku", "fn", "populateValues"},
               {xqSeqType, 'xs:integer', zero_or_many}, [],
               {xqerl_main, '__Q{sudoku}populateValues', 3}, 2,
               [{xqSeqType, 'xs:integer', one_or_many},
                {xqSeqType, 'xs:integer', zero_or_many}]},
                   {{qname, "sudoku", "fn", "solveSudoku"}, {xqSeqType, 'xs:integer', one_or_many},
               [], {xqerl_main, '__Q{sudoku}solveSudoku', 2}, 1,
               [{xqSeqType, 'xs:integer', one_or_many}]},
                   {{qname, "sudoku", "fn", "drawResult"},
               {xqSeqType, {xqKindTest, element, undefined, undefined, undefined}, one}, [],
               {xqerl_main, '__Q{sudoku}drawResult', 2}, 1,
               [{xqSeqType, 'xs:integer', one_or_many}]},
                   {{qname, "sudoku", "fn", "drawBoard"},
               {xqSeqType, {xqKindTest, element, undefined, undefined, undefined}, one}, [],
               {xqerl_main, '__Q{sudoku}drawBoard', 2}, 1,
               [{xqSeqType, 'xs:integer', one_or_many}]},
               ...
               {xqSeqType, item, zero_or_many}, [], {xqerl_fn, collection, 1}, 0, []},
                   {{qname, "http://www.w3.org/2005/xpath-functions", "fn", "collection"},
               {xqSeqType, item, zero_or_many}, [], {xqerl_fn, collection, 2}, 1,
               [{xqSeqType, 'xs:string', zero_or_one}]},
               ...
               {xqSeqType,
                {xqKindTest, 'document-node', undefined,
                 {xqKindTest, element, undefined, undefined, undefined}, undefined},
                one},
               ...
               [{xqSeqType, {xqKindTest, node, undefined, undefined, undefined}, one},
                {xqSeqType, 'xs:string', one}]}]),
    maps:put(tab, Tab,
        #{'base-uri' => {xqAtomicValue, 'xs:anyURI', "xqerl_main"},
          'construction-mode' => preserve, 'copy-namespaces' => {preserve, 'no-inherit'},
          'default-collation' =>
         ...
         ["http://www.w3.org/2010/09/qt-fots-catalog/collation/caseblind",
          ...
          "http://www.w3.org/2005/xpath-functions/collation/html-ascii-c"
          "ase-insensitive"],
          known_dec_formats =>
         [{[],
           {dec_format, ".", ",", "Infinity", "-", "NaN", "%", [8240], "0", "#", ";",
            "e"}}],
          namespaces =>
         [{xqNamespace, 'no-namespace', []},
          {xqNamespace, "http://www.w3.org/2005/xquery-local-functions", "local"},
          {xqNamespace, "sudoku", "fn"},
...
'__Q{http://www.w3.org/2005/xquery-local-functions}children'(Ctx0,
                          Param__var_1) ->
    Ctx__1 = xqerl_context:set_empty_context_item(Ctx0),
    xqerl_step:forward(Ctx__1, Param__var_1, child,
             {xqKindTest, node, undefined, undefined, undefined}, []).

'__Q{http://www.w3.org/2005/xquery-local-functions}self'(Ctx0, Param__var_5) ->
    Ctx__1 = xqerl_context:set_empty_context_item(Ctx0), Param__var_5.

'__Q{http://www.w3.org/2005/xquery-local-functions}attributes'(Ctx0,
                            Param__var_3) ->
    Ctx__1 = xqerl_context:set_empty_context_item(Ctx0),
    xqerl_step:forward(Ctx__1, Param__var_3, attribute,
             {xqKindTest, node, undefined, undefined, undefined}, []).

'__Q{http://www.w3.org/2005/xquery-local-functions}union'(Ctx0, Param__var_7,
                       Param__var_8) ->
    Ctx__1 = xqerl_context:set_empty_context_item(Ctx0),
    {xqFunction, undefined, undefined, undefined, 1,
     [{xqSeqType, item, zero_or_many}], {xqSeqType, item, zero_or_many},
     fun (Ctx__1, Param__var_9) ->
        Ctx__2 = Ctx__1,
        xqerl_seq3:union(xqerl_seq3:val_map(fun (Local__1)
                      when erlang:is_map(Local__1) ->
                      xqerl_operators:lookup(Ctx__2, Local__1, xqerl_seq3:ensure_one(Param__var_9));
                      ...
                      xqerl_operators:lookup(Ctx__2, Local__1, xqerl_seq3:ensure_one(Param__var_9));
                       (Ctx__3) ->
                      Local__1 = xqerl_types:value(Param__var_7),
                      if erlang:is_function(Local__1) ->
                        case Local__1 == fun xqerl_fn:concat/2 of
                          true ->
                              Local__1(Ctx__2,
                                  xqerl_seq3:flatten([xqerl_seq3:ensure_one(Param__var_9)]));
                          _ -> Local__1(Ctx__2, xqerl_seq3:ensure_one(Param__var_9))
                        end;
                         true ->
                        xqerl_operators:lookup(Ctx__2, Local__1,
                                     xqerl_seq3:ensure_one(Param__var_9))
                      end
                   end,
                   Param__var_7),
               xqerl_seq3:val_map(fun (Local__2) when erlang:is_map(Local__2) ->
                      xqerl_operators:lookup(Ctx__2, Local__2, xqerl_seq3:ensure_one(Param__var_9));
                       ([]) -> xqerl_error:error('XPTY0004');
                      ...
                      xqerl_operators:lookup(Ctx__2, Local__2, xqerl_seq3:ensure_one(Param__var_9));
                       (Ctx__4) ->
                      Local__2 = xqerl_types:value(Param__var_8),
                      if erlang:is_function(Local__2) ->
                        case Local__2 == fun xqerl_fn:concat/2 of
                          true ->
                              Local__2(Ctx__2,
                                  xqerl_seq3:flatten([xqerl_seq3:ensure_one(Param__var_9)]));
                          _ -> Local__2(Ctx__2, xqerl_seq3:ensure_one(Param__var_9))
                        end;
                         true ->
                        xqerl_operators:lookup(Ctx__2, Local__2,
                                     xqerl_seq3:ensure_one(Param__var_9))
                      end
                   end,
                   Param__var_8))
...
main(Options) ->
    ...
    Ctx = begin
       Local__3 = xqerl_types:promote(maps:get('context-item', Options, []),
                  {xqSeqType, item, zero_or_one}),
       xqerl_context:set_context_item(Ctx0, Local__3, 1,
                  {xqAtomicValue, 'xs:integer', xqerl_seq3:size(Local__3)})
     end,
    begin
      Query = xqerl_seq3:flatten(begin VarTup__1 = let__12(Ctx, new) end),
      ReturnVal = xqerl_types:return_value(Query),
      xqerl_context:destroy(Ctx),
      ReturnVal
    end.

-compile({inline, {return__14, 2}}).

return__14(_, []) -> [];
return__14(Ctx, List) when erlang:is_list(List) ->
    [return__14(Ctx, T) || T <- List];
return__14(Ctx, {XQ__var_12, XQ__var_13}) ->
   ?dbg("K",xqerl_step:forward(Ctx, XQ__var_12, child, {qname, "*", "*", "*"}, [])),
    xqerl_seq3:filter(Ctx,
            fun (Ctx__3) ->
                   C1 = xqerl_context:get_context_item(Ctx__3),
                   ?dbg("C1",C1),
                   C2 = xqerl_types:instance_of(C1,{xqSeqType,{xqKindTest, attribute, undefined,undefined, undefined},one}),
                   ?dbg("C2",C2),
               xqerl_fn:'not'(Ctx__3,
                    xqerl_seq3:ensure_zero_or_more(C2))
            end,
            xqerl_fn:'for-each'(Ctx,
                 xqerl_step:forward(Ctx, XQ__var_12, child, {qname, "*", "*", "*"}, []),
                 xqerl_seq3:ensure_zero_or_more(XQ__var_13))).

-compile({inline, {let__13, 2}}).

let__13(Ctx, List) when erlang:is_list(List) ->
    lists:flatten([let__13(Ctx, T) || T <- List]);
let__13(Ctx, {XQ__var_12}) ->
    XQ__var_13 =
   xqerl_seq3:ensure_zero_or_more('__Q{http://www.w3.org/2005/xquery-local-functions}union'(Ctx,
                                     {xqFunction, 0, [],
                                      {qname,
                                      ...
                                      1,
                                      [{xqSeqType,
                                        {xqKindTest, node, undefined, undefined,
                                         undefined},
                                        one}],
                                      {xqSeqType,
                                       {xqKindTest, node, undefined, undefined,
                                        undefined},
                                       zero_or_many},
                                      fun '__Q{http://www.w3.org/2005/xquery-local-functions}children'/2},
                                     '__Q{http://www.w3.org/2005/xquery-local-functions}union'(Ctx,
                                                            {xqFunction,
                                                             0,
                                                             [],
                                                             {qname,
                                                             ...
                                                             {xqSeqType,
                                                              {xqKindTest,
                                                               ...
                                                               undefined},
                                                              zero_or_many},
                                                             fun '__Q{http://www.w3.org/2005/xquery-local-functions}attributes'/2},
                                                            {xqFunction,
                                                             0,
                                                             [],
                                                             {qname,
                                                             ...
                                                             {xqSeqType,
                                                              {xqKindTest,
                                                               ...
                                                               undefined},
                                                              one},
                                                             fun '__Q{http://www.w3.org/2005/xquery-local-functions}self'/2}))),
    return__14(Ctx, {XQ__var_12, XQ__var_13}).
...
let__12(Ctx, _) ->
    XQ__var_12 = xqerl_seq3:flatten([xqerl_step:forward(Ctx,
                     xqerl_step:root(Ctx, xqerl_context:get_context_item(Ctx)), child,
                     {qname, 'no-namespace', [], "a"}, [])]),
    let__13(Ctx, {XQ__var_12}).