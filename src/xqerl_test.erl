...
run() ->
   ...
   %run_suite(fn_subsequence_SUITE), % TODO fn:count on 1 to N sequence
   %run_suite(prod_VarDecl_SUITE),          % TODO cyclic prod_VarDecl_SUITE:'K2-InternalVariablesWithout-9'/1
   %run_suite(prod_VarDecl_external_SUITE), % TODO cyclic prod_VarDecl_SUITE:'K2-InternalVariablesWithout-9'/1
...
%%    run_suite(fn_matches_re_no_is_SUITE),
...
.
run_suite(Suite) ->
   ct:run_test([{},{suite, Suite},{dir, "/git/xqerl/test"},{logdir, "/git/xqerl/test/logs"}])
.
