...
{{qname,?NS, ?PX, <<"append">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'append', 3}, 2,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, item, zero_or_many}]},
{{qname, ?NS,?PX, <<"filter">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'filter', 3}, 2,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType,{funTest, function, [], undefined,[{seqType, item, zero_or_many}],{seqType, 'xs:boolean', one}},one}]},
{{qname, ?NS,?PX, <<"flatten">>},{seqType, item, zero_or_many}, [], 
 {'flatten', 2}, 1,[{seqType, item, zero_or_many}]},
{{qname, ?NS,?PX, <<"fold-left">>},{seqType, item, zero_or_many}, [], 
 {'fold-left', 4}, 3,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, item, zero_or_many},{seqType,{funTest, function, [], undefined,[{seqType, item, zero_or_many},{seqType, item, zero_or_many}],{seqType, item, zero_or_many}},one}]},
{{qname, ?NS,?PX, <<"fold-right">>},{seqType, item, zero_or_many}, [], 
 {'fold-right', 4}, 3,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, item, zero_or_many},{seqType,{funTest, function, [], undefined,[{seqType, item, zero_or_many},{seqType, item, zero_or_many}],{seqType, item, zero_or_many}},one}]},
{{qname, ?NS,?PX, <<"for-each">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'for-each', 3}, 2,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType,{funTest, function, [], undefined,[{seqType, item, zero_or_many}],{seqType, item, zero_or_many}},one}]},
{{qname, ?NS,?PX, <<"for-each-pair">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'for-each-pair', 4}, 3,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, {funTest, array, [], undefined, any, any},one},{seqType,{funTest, function, [], undefined,[{seqType, item, zero_or_many},{seqType, item, zero_or_many}],{seqType, item, zero_or_many}},one}]},
{{qname, ?NS,?PX, <<"get">>},{seqType, item, zero_or_many}, [], 
 {'get', 3}, 2,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:integer', one}]},
{{qname, ?NS,?PX, <<"head">>},{seqType, item, zero_or_many}, [], 
 {'head', 2}, 1,[{seqType,{funTest, array, [], undefined, any, any}, one}]},
{{qname, ?NS,?PX, <<"insert-before">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'insert-before', 4}, 3,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:integer', one},{seqType, item, zero_or_many}]},
...
{{qname, ?NS,?PX, <<"put">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'put', 4}, 3,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:integer', one},{seqType, item, zero_or_many}]},
{{qname, ?NS,?PX, <<"remove">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'remove', 3}, 2,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:integer', zero_or_many}]},
{{qname, ?NS,?PX, <<"reverse">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'reverse', 2}, 1,[{seqType,{funTest, array, [], undefined, any, any}, one}]},
{{qname, ?NS,?PX, <<"size">>},{seqType, 'xs:integer', one}, [], 
 {'size', 2}, 1,[{seqType,{funTest, array, [], undefined, any, any}, one}]},
{{qname, ?NS,?PX, <<"sort">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'sort', 2}, 1,[{seqType,{funTest, array, [], undefined, any, any}, one}]},
{{qname, ?NS,?PX, <<"sort">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'sort', 3}, 2,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:string', zero_or_one}]},
{{qname, ?NS,?PX, <<"sort">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'sort', 4}, 3,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:string', zero_or_one},{seqType,{funTest, function, [], undefined,[{seqType, item, zero_or_many}],{seqType, 'xs:anyAtomicType', zero_or_many}},one}]},
{{qname, ?NS,?PX, <<"subarray">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'subarray', 3}, 2,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:integer', one}]},
{{qname, ?NS,?PX, <<"subarray">>},{seqType, {funTest, array, [], undefined, any, any},one},[], 
 {'subarray', 4}, 3,[{seqType,{funTest, array, [], undefined, any, any}, one},{seqType, 'xs:integer', one},{seqType, 'xs:integer', one}]},
...
'for-each-pair'(Ctx, Array1, Array2,
...
'remove'(_Ctx, [Array], Positions) -> 'remove'(_Ctx, Array, Positions);
'remove'(_Ctx, Array, Positions) ->
    case array:is_array(Array) of
        false ->
            ?err('FORG0006');
        true ->
            IntList = [xqerl_types:value(V) || 
...
'reverse'(_Ctx, [Array]) -> 'reverse'(_Ctx, Array);
'reverse'(_Ctx, Array) ->
    case array:is_array(Array) of
        false ->
            ?err('FORG0006');
...
'size'(_Ctx, [Array]) -> 'size'(_Ctx, Array);
'size'(_Ctx, Array) -> 
    case array:is_array(Array) of
        false ->
            ?err('FORG0006');
...
from_list(List) when is_list(List) ->
    List1 = [case xqerl_seq3:expand(L) of
                 [X] -> X;
                 X -> X
             end || L <- List],
