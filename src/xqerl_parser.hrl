...
-define(node(I),
    (I == 'node' orelse
        I == 'document' orelse
        I == 'document-node' orelse
        I == 'element' orelse
        I == 'attribute' orelse
        I == 'namespace' orelse
        I == 'text' orelse I == 'comment' orelse I == 'processing-instruction')
).
...
-type xqSetters() ::
    #xqDecimalFormatDecl{}
    | #xqCopyNamespacesDecl{}
    | #xqEmptyOrderDecl{}
    | #xqOrderingModeDecl{}
    | #xqConstructionDecl{}
    | #xqBaseURIDecl{}
    | #xqDefaultCollationDecl{}
    | #xqBoundarySpaceDecl{}
    | #xqRevalidationDecl{}.
...
-record(xqFunctionCall, {
    ...
    args :: undefined | [term()],
    % after the static phase this is set
    call :: undefined | #xqFunctionDef{}
}).
