...
msg('XPST0001') ->
    <<"It is a static error if analysis of an expression relies on some component of the static context that has not been assigned a valueis .">>;
msg('XPDY0002') ->
    <<"It is a dynamic error if evaluation of an expression relies on some part of the dynamic context that has not been assigned a valueis .">>;
msg('XPST0003') ->
...
msg('XQST0012') ->
    <<"It is a static error if the set of definitions contained in all schemas imported by a Prolog do not satisfy the conditions for schema validity specified in Sections 3 and 5 of Part 1 of or --i.e., each definition must be valid, complete, and unique.">>;
msg('XQST0013') ->
...
msg('XQST0022') ->
    <<"It is a static error if the value of a namespace declaration attribute is not a URILiteral.contains an EnclosedExpr.">>;
msg('XQTY0024') ->
...
msg('XQST0046') ->
    <<"An implementation MAYMAY raise a static error if the value of a URILiteral or a BracedURILiteral is of nonzero length and is not in the lexical space of xs:anyURIneither an absolute URI nor a relative URI.">>;
msg('XQST0047') ->
...
msg('XQST0052') ->
    <<"The type named in a cast or castable expression must be the name of a type defined in the in-scope schema types, and the{variety} of the type must be simple.">>;
msg('XQDY0054') ->
...
msg('XQST0075') ->
    <<"An implementation that does not support the Schema Aware Feature Validation Feature must raise a static error if it encounters a validate expression.">>;
msg('XQST0076') ->
...
msg('XQST0085') ->
    <<"It is a static error if the namespace URI in a namespace declaration attribute is a zero-length string, and the implementation does not support .">>;
msg('XQTY0086') ->
...
msg('XQST0087') ->
    <<"It is a static error if the encoding specified in a Version Declaration does not conform to the definition of EncName specified in .">>;
msg('XQST0088') ->
...
msg('XQDY0091') ->
    <<"An implementation MAY raise a dynamic error if an xml:id error, as defined in , is encountered during construction of an attribute named xml:id.">>;
msg('XQDY0092') ->
...
msg('XQST0099') ->
    <<"A ContextItemDecl must not occur after an expression that relies on the initial context item, and no queryNo module may contain more than one ContextItemDecl.">>;
msg('XQDY0101') ->
    <<"An error is raised if a computed namespace constructor attempts to do any of the following: Bind the prefix xml to some namespace URI other than http://www.w3.org/XML/1998/namespace. Bind a prefix other than xml to the namespace URI http://www.w3.org/XML/1998/namespace. Bind the prefix xmlns to any namespace URI. Bind a prefix to the namespace URI http://www.w3.org/2000/xmlns/. Bind any prefix (including the empty prefix) to a zero-length namespace URI.">>;
msg('XQDY0102') ->
    <<"In an element constructor, if two or more namespace bindings in the in-scope bindings would have the same prefix, then an error is raised if they have different URIs; if they would have the same prefix and URI, duplicate bindings are ignored. If the name of an element in an element constructor is in no namespace, creating a default namespace for that element using a computed namespace constructor is an error.">>;
msg('XQST0103') ->
...
msg('XQST0106') ->
    <<"It is a static error if a function declaration contains both a %private and a %public annotation. It is a static error if a function's annotations contain more than one annotation named %private or %public, more than one %private annotation, or more than one %public annotation. It is a static error if a function's annotations contain more than one annotation named %deterministic or %nondeterministic.">>;
msg('XQST0108') ->
    <<"It is a static error if an output declaration occurs in a library module.">>;
msg('XQST0109') ->
    <<"It is a static error if the local name of an output declaration in the http://www.w3.org/2010/xslt-xquery-serialization namespace is not one of the serialization parameter names listed in , or if the name of an output declaration is use-character-maps.">>;
msg('XQST0110') ->
...
msg('XQST0116') ->
    <<"It is a static error if a variable declaration's annotations contain more than one annotation named %private or %public. if a variable declaration contains both a %private and a %public annotation, more than one %private annotation, or more than one %public annotation.">>;
msg('XPTY0117') ->
...
msg('XQST0129') ->
    <<"An implementation that does not provide the Higher-Order Function Feature MUST raise a static error if it encounters a FunctionTest, dynamic function call, named function reference, inline function expression, or partial function application.">>;
msg('XPDY0130') ->
...
msg('XUDY0037') ->
    <<"It is a dynamic error if the pending update list returned by the modify expression of a CopyModifyExpr or TransformWithExpr contains a upd:put update primitive.">>;
msg('XUDY0038') ->
