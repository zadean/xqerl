...
norm_str(<<>>, Acc) ->
    Acc;
norm_str(<<$\\, $", T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $">>);
norm_str(<<$\\, $\\, T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $\\>>);
norm_str(<<$\\, $/, T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $/>>);
norm_str(<<$\\, $b, T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $\b>>);
norm_str(<<$\\, $f, T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $\f>>);
norm_str(<<$\\, $n, T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $\n>>);
norm_str(<<$\\, $r, T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $\r>>);
norm_str(<<$\\, $t, T/binary>>, Acc) ->
    norm_str(T, <<Acc/binary, $\t>>);
