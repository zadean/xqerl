...
-export([decode_string/2, decode_string/3, decode_string/4, decode_string/5,
         encode_string/2, encode_string/3]).
%% 8 Packing and unpacking of encoded numeric values
-export([pack_double/2, pack_double/3,
...
-functions([
%% 5 Defining 'constants' and conversions
{{qname, ?NS, ?PX, <<"hex">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {hex, 2}, 1, [{xqSeqType, 'xs:string', zero_or_one}]},
{{qname, ?NS, ?PX, <<"bin">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {bin, 2}, 1, [{xqSeqType, 'xs:string', zero_or_one}]},
{{qname, ?NS, ?PX, <<"octal">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {octal, 2}, 1, [{xqSeqType, 'xs:string', zero_or_one}]},
{{qname, ?NS, ?PX, <<"to-octets">>}, {xqSeqType, 'xs:integer', zero_or_many}, [], 
 {to_octets, 2}, 1, [{xqSeqType, 'xs:base64Binary', one}]},
{{qname, ?NS, ?PX, <<"from-octets">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {from_octets, 2}, 1, [{xqSeqType, 'xs:integer', zero_or_many}]},
%% 6 Basic operations
{{qname, ?NS, ?PX, <<"length">>}, {xqSeqType, 'xs:integer', one}, [], 
 {length, 2}, 1, [{xqSeqType, 'xs:base64Binary', one}]},
{{qname, ?NS, ?PX, <<"part">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {part, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"part">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {part, 4}, 3, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                {xqSeqType, 'xs:integer', one},
                {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"join">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {join, 2}, 1, [{xqSeqType, 'xs:base64Binary', zero_or_many}]},
{{qname, ?NS, ?PX, <<"insert-before">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {insert_before, 4}, 3, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                         {xqSeqType, 'xs:integer', one},
                         {xqSeqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"pad-left">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_left, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                    {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pad-left">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_left, 4}, 3, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                    {xqSeqType, 'xs:integer', one},
                    {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pad-right">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_right, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                     {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pad-right">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {pad_right, 4}, 3, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                     {xqSeqType, 'xs:integer', one},
                     {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"find">>}, {xqSeqType, 'xs:integer', zero_or_one}, [], 
 {find, 4}, 3, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                {xqSeqType, 'xs:integer', one},
                {xqSeqType, 'xs:base64Binary', one}]},
%% 7 Text decoding and encoding
{{qname, ?NS, ?PX, <<"decode-string">>}, {xqSeqType, 'xs:string', zero_or_one}, [], 
 {decode_string, 2}, 1, [{xqSeqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"decode-string">>}, {xqSeqType, 'xs:string', zero_or_one}, [], 
 {decode_string, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                         {xqSeqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"decode-string">>}, {xqSeqType, 'xs:string', zero_or_one}, [], 
 {decode_string, 4}, 3, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                         {xqSeqType, 'xs:string', one},
                         {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"decode-string">>}, {xqSeqType, 'xs:string', zero_or_one}, [], 
 {decode_string, 5}, 4, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                         {xqSeqType, 'xs:string', one},
                         {xqSeqType, 'xs:integer', one},
                         {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"encode-string">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {encode_string, 2}, 1, [{xqSeqType, 'xs:string', zero_or_one}]},
{{qname, ?NS, ?PX, <<"encode-string">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {encode_string, 3}, 2, [{xqSeqType, 'xs:string', zero_or_one},
                         {xqSeqType, 'xs:string', one}]},
%% 8 Packing and unpacking of encoded numeric values
{{qname, ?NS, ?PX, <<"pack-double">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {pack_double, 2}, 1, [{xqSeqType, 'xs:double', one}]},
{{qname, ?NS, ?PX, <<"pack-double">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {pack_double, 3}, 2, [{xqSeqType, 'xs:double', one},
                       {xqSeqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"pack-float">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {pack_float, 2}, 1, [{xqSeqType, 'xs:float', one}]},
{{qname, ?NS, ?PX, <<"pack-float">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {pack_float, 3}, 2, [{xqSeqType, 'xs:float', one},
                      {xqSeqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"pack-integer">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {pack_integer, 3}, 2, [{xqSeqType, 'xs:integer', one},
                        {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"pack-integer">>}, {xqSeqType, 'xs:base64Binary', one}, [], 
 {pack_integer, 4}, 3, [{xqSeqType, 'xs:integer', one},
                        {xqSeqType, 'xs:integer', one},
                        {xqSeqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-double">>}, {xqSeqType, 'xs:double', zero_or_one}, [], 
 {unpack_double, 3}, 2, [{xqSeqType, 'xs:base64Binary', one},
                         {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-double">>}, {xqSeqType, 'xs:double', zero_or_one}, [], 
 {unpack_double, 4}, 3, [{xqSeqType, 'xs:base64Binary', one},
                         {xqSeqType, 'xs:integer', one},
                         {xqSeqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-float">>}, {xqSeqType, 'xs:float', one}, [], 
 {unpack_float, 3}, 2, [{xqSeqType, 'xs:base64Binary', one},
                        {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-float">>}, {xqSeqType, 'xs:float', one}, [], 
 {unpack_float, 4}, 3, [{xqSeqType, 'xs:base64Binary', one},
                        {xqSeqType, 'xs:integer', one},
                        {xqSeqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-integer">>}, {xqSeqType, 'xs:integer', one}, [], 
 {unpack_integer, 4}, 3, [{xqSeqType, 'xs:base64Binary', one},
                          {xqSeqType, 'xs:integer', one},
                          {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-integer">>}, {xqSeqType, 'xs:integer', one}, [], 
 {unpack_integer, 5}, 4, [{xqSeqType, 'xs:base64Binary', one},
                          {xqSeqType, 'xs:integer', one},
                          {xqSeqType, 'xs:integer', one},
                          {xqSeqType, 'xs:string', one}]},
{{qname, ?NS, ?PX, <<"unpack-unsigned-integer">>}, {xqSeqType, 'xs:integer', one}, [], 
 {unpack_unsigned_integer, 4}, 3, [{xqSeqType, 'xs:base64Binary', one},
                                   {xqSeqType, 'xs:integer', one},
                                   {xqSeqType, 'xs:integer', one}]},
{{qname, ?NS, ?PX, <<"unpack-unsigned-integer">>}, {xqSeqType, 'xs:integer', one}, [], 
 {unpack_unsigned_integer, 5}, 4, [{xqSeqType, 'xs:base64Binary', one},
                                   {xqSeqType, 'xs:integer', one},
                                   {xqSeqType, 'xs:integer', one},
                                   {xqSeqType, 'xs:string', one}]},
%% 9 Bitwise operations
{{qname, ?NS, ?PX, <<"or">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {or_, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                {xqSeqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"xor">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {xor_, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                 {xqSeqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"and">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {and_, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                 {xqSeqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"not">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {not_, 2}, 1, [{xqSeqType, 'xs:base64Binary', zero_or_one}]},
{{qname, ?NS, ?PX, <<"shift">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {shift, 3}, 2, [{xqSeqType, 'xs:base64Binary', zero_or_one},
                 {xqSeqType, 'xs:integer', one}]}
]).
...
bin(_, String) when is_binary(String) ->
   Rem = case byte_size(String) rem 8 of
            0 -> 0;
            V -> 8 - V
         end,
...
from_octets(_, List) when is_list(List) ->
   Check = fun(I) when is_integer(I), I >= 0, I =< 255 ->
                 I;
              (I) when is_integer(I) ->
...
part(_, ?bin(_), Off, _) when is_integer(Off), Off < 0 -> 
   do_throw('index-out-of-range');
part(_, ?bin(_), _, 0) -> ?bin(<<>>);
part(_, [], _, _) -> [];
part(_, ?bin(Bin), Off, Size) when is_integer(Off), 
                                   is_integer(Size) ->
   case Bin of
...
pad_left(_, _, S, _) when is_integer(S), S < 0 ->
   do_throw('negative-size');
pad_left(_, _, _, O) when is_integer(O) andalso O < 0;
                          is_integer(O) andalso O > 255 ->
   do_throw('octet-out-of-range');
pad_left(_, ?bin(I), S, O) when is_integer(S),
                                is_integer(O) ->
   Pad = binary:copy(<<O>>, S),
...
pad_right(_, _, S, _) when is_integer(S), S < 0 ->
   do_throw('negative-size');
pad_right(_, _, _, O) when is_integer(O) andalso O < 0;
                           is_integer(O) andalso O > 255 ->
   do_throw('octet-out-of-range');
pad_right(_, ?bin(I), S, O) when is_integer(S),
                                 is_integer(O) ->
   Pad = binary:copy(<<O>>, S),
...
%%       larger than the size of the binary data of $in.
find(_, [], _, _) -> [];
find(_, ?bin(I), O, ?bin(<<>>)) when is_integer(O),
                                     O =< byte_size(I),
                                     O >= 0 ->
   O;
find(_, ?bin(I), O, ?bin(S)) when is_integer(O),
                                  O =< byte_size(I),
                                  O >= 0 ->
   Opts = if O == 0 -> [];
...
decode_string(_, []) -> [];
decode_string(C, I) ->
   decode_string(C, I, <<"UTF-8">>).

decode_string(_, [], _) -> [];
decode_string(C, I, E) ->
   decode_string(C, I, E, 0).
...
decode_string(C, I, E, O) ->
   decode_string(C, 
                 xqerl_types:cast_as(I, 'xs:base64Binary'), E, 
                 xqerl_types:cast_as(O, 'xs:integer')).

decode_string(_, [], _, _, _) -> [];
decode_string(_, _, _, O, _) when is_integer(O),
                                  O < 0 ->
   do_throw('index-out-of-range');
decode_string(_, ?bin(I), _, O, S) when is_integer(O),
                                        is_integer(S),
                                        (O + S) > byte_size(I) ->
   do_throw('index-out-of-range');
decode_string(_, _, _, _, S) when is_integer(S),
                                  S < 0 ->
   do_throw('negative-size');
decode_string(_, ?bin(I), E, O, S) when is_binary(E),
                                        is_integer(O),
                                        is_integer(S) ->
...
encode_string(_, [], _) -> [];
encode_string(_, I, E) when is_binary(I),
                            is_binary(E) ->
   Enc = check_encoding(E),
...
pack_integer(_, _, S, _) when is_integer(S),
                              S < 0 ->
   do_throw('negative-size');
pack_integer(_, _, 0, _) -> ?bin(<<>>);
pack_integer(_, I, S, O) when is_integer(I),
                              is_integer(S),
                              is_binary(O) ->
   Bits = S * 8,
   case check_endianness(O) of
...
unpack_double(_, ?bin(I), O, _) when is_integer(O) andalso O < 0;
                                     is_integer(O) andalso 
                                       (O + 8) > byte_size(I) ->
   do_throw('index-out-of-range');
unpack_double(_, ?bin(I), O, E) when is_integer(O),
                                     is_binary(E) ->
...
unpack_float(_, ?bin(I), O, _) when is_integer(O) andalso O < 0;
                                    is_integer(O) andalso 
                                      (O + 4) > byte_size(I) ->
   do_throw('index-out-of-range');
unpack_float(_, ?bin(I), O, E) when is_integer(O),
                                    is_binary(E) ->
...
unpack_integer(_, ?bin(I), O, S, _) when is_integer(O) andalso O < 0;
                                         is_integer(O) andalso 
...
unpack_integer(_, _, _, S, _) when is_integer(S), S < 0 ->
   do_throw('negative-size');
unpack_integer(_, ?bin(I), O, S, E) when is_integer(O),
                                         is_integer(S),
                                         is_binary(E) ->
   Bits = S * 8,
   case check_endianness(E) of
...
unpack_unsigned_integer(_, ?bin(I), O, S, _) when is_integer(O) andalso O < 0;
                                                  is_integer(O) andalso
                                                    is_integer(S) andalso
                                                    (O + S) > byte_size(I) ->
   do_throw('index-out-of-range');
unpack_unsigned_integer(_, _, _, S, _) when is_integer(S), S < 0 ->
   do_throw('negative-size');
unpack_unsigned_integer(_, ?bin(I), O, S, E) when is_integer(O),
                                                  is_integer(S),
                                                  is_binary(E) ->
   Bits = S * 8,
   case check_endianness(E) of
...
do_throw('differing-length-arguments') ->
   E = #xqError{description = <<"The arguments to a bitwise operation are of differing length.">>,
                name = ?Q(<<"differing-length-arguments">>)
                },
   exit(E);
do_throw('index-out-of-range') ->
   E = #xqError{description = <<"Attempting to retrieve data outside the meaningful range of a binary data type.">>,
                name = ?Q(<<"index-out-of-range">>)
                },
   exit(E);
do_throw('negative-size') ->
   E = #xqError{description = <<"Size of binary portion, required numeric size or padding is negative.">>,
                name = ?Q(<<"negative-size">>)
                },
   exit(E);
do_throw('octet-out-of-range') ->
   E = #xqError{description = <<"Attempting to pack binary value with octet outside range.">>,
                name = ?Q(<<"octet-out-of-range">>)
                },
   exit(E);
do_throw('non-numeric-character') ->
   E = #xqError{description = <<"Wrong character in binary 'numeric constructor' string.">>,
                name = ?Q(<<"non-numeric-character">>)
                },
   exit(E);
do_throw('unknown-encoding') ->
   E = #xqError{description = <<"The specified encoding is not supported.">>,
                name = ?Q(<<"unknown-encoding">>)
                },
   exit(E);
do_throw('conversion-error') ->
   E = #xqError{description = <<"Error in converting to/from a string.">>,
                name = ?Q(<<"conversion-error">>)
                },
   exit(E);
do_throw('unknown-significance-order') ->
   E = #xqError{description = <<"Unknown octet-order value.">>,
