...
-namespaces([{?NS, ?PX}]).
-functions([ 
{{qname, ?NS, ?PX, <<"unsignedInt">>}, {xqSeqType, 'xs:unsignedInt', zero_or_one}, [], 
 {'xs_unsignedInt', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"string">>}, {xqSeqType, 'xs:string', zero_or_one}, [], 
 {'xs_string', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"boolean">>}, {xqSeqType, 'xs:boolean', zero_or_one}, [], 
 {'xs_boolean', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"decimal">>}, {xqSeqType, 'xs:decimal', zero_or_one}, [], 
 {'xs_decimal', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"float">>}, {xqSeqType, 'xs:float', zero_or_one}, [], 
 {'xs_float', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"double">>}, {xqSeqType, 'xs:double', zero_or_one}, [], 
 {'xs_double', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"duration">>}, {xqSeqType, 'xs:duration', zero_or_one}, [], 
 {'xs_duration', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"dateTime">>}, {xqSeqType, 'xs:dateTime', zero_or_one}, [], 
 {'xs_dateTime', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"time">>}, {xqSeqType, 'xs:time', zero_or_one}, [], 
 {'xs_time', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"date">>}, {xqSeqType, 'xs:date', zero_or_one}, [], 
 {'xs_date', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"gYearMonth">>}, {xqSeqType, 'xs:gYearMonth', zero_or_one}, [], 
 {'xs_gYearMonth', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"gYear">>}, {xqSeqType, 'xs:gYear', zero_or_one}, [], 
 {'xs_gYear', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"gMonthDay">>}, {xqSeqType, 'xs:gMonthDay', zero_or_one}, [], 
 {'xs_gMonthDay', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"gDay">>}, {xqSeqType, 'xs:gDay', zero_or_one}, [], 
 {'xs_gDay', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"gMonth">>}, {xqSeqType, 'xs:gMonth', zero_or_one}, [], 
 {'xs_gMonth', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"hexBinary">>}, {xqSeqType, 'xs:hexBinary', zero_or_one}, [], 
 {'xs_hexBinary', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"base64Binary">>}, {xqSeqType, 'xs:base64Binary', zero_or_one}, [], 
 {'xs_base64Binary', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"anyURI">>}, {xqSeqType, 'xs:anyURI', zero_or_one}, [], 
 {'xs_anyURI', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"QName">>}, {xqSeqType, 'xs:QName', zero_or_one}, [], 
 {'xs_QName', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"normalizedString">>}, {xqSeqType, 'xs:normalizedString', zero_or_one}, [], 
 {'xs_normalizedString', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"token">>}, {xqSeqType, 'xs:token', zero_or_one}, [], 
 {'xs_token', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"language">>}, {xqSeqType, 'xs:language', zero_or_one}, [], 
 {'xs_language', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"NMTOKEN">>}, {xqSeqType, 'xs:NMTOKEN', zero_or_one}, [], 
 {'xs_NMTOKEN', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"Name">>}, {xqSeqType, 'xs:Name', zero_or_one}, [], 
 {'xs_Name', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"NCName">>}, {xqSeqType, 'xs:NCName', zero_or_one}, [], 
 {'xs_NCName', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"ID">>}, {xqSeqType, 'xs:ID', zero_or_one}, [], 
 {'xs_ID', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"IDREF">>}, {xqSeqType, 'xs:IDREF', zero_or_one}, [], 
 {'xs_IDREF', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"ENTITY">>}, {xqSeqType, 'xs:ENTITY', zero_or_one}, [], 
 {'xs_ENTITY', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"integer">>}, {xqSeqType, 'xs:integer', zero_or_one}, [], 
 {'xs_integer', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"nonPositiveInteger">>}, {xqSeqType, 'xs:nonPositiveInteger', zero_or_one}, [], 
 {'xs_nonPositiveInteger', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"negativeInteger">>}, {xqSeqType, 'xs:negativeInteger', zero_or_one}, [], 
 {'xs_negativeInteger', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"long">>}, {xqSeqType, 'xs:long', zero_or_one}, [], 
 {'xs_long', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"int">>}, {xqSeqType, 'xs:int', zero_or_one}, [], 
 {'xs_int', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"short">>}, {xqSeqType, 'xs:short', zero_or_one}, [], 
 {'xs_short', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"byte">>}, {xqSeqType, 'xs:byte', zero_or_one}, [], 
 {'xs_byte', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"nonNegativeInteger">>}, {xqSeqType, 'xs:nonNegativeInteger', zero_or_one}, [], 
 {'xs_nonNegativeInteger', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"unsignedLong">>}, {xqSeqType, 'xs:unsignedLong', zero_or_one}, [], 
 {'xs_unsignedLong', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"unsignedShort">>}, {xqSeqType, 'xs:unsignedShort', zero_or_one}, [], 
 {'xs_unsignedShort', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"unsignedByte">>}, {xqSeqType, 'xs:unsignedByte', zero_or_one}, [], 
 {'xs_unsignedByte', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"positiveInteger">>}, {xqSeqType, 'xs:positiveInteger', zero_or_one}, [], 
 {'xs_positiveInteger', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"yearMonthDuration">>}, {xqSeqType, 'xs:yearMonthDuration', zero_or_one}, [], 
 {'xs_yearMonthDuration', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"dayTimeDuration">>}, {xqSeqType, 'xs:dayTimeDuration', zero_or_one}, [], 
 {'xs_dayTimeDuration', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"untypedAtomic">>}, {xqSeqType, 'xs:untypedAtomic', zero_or_one}, [], 
 {'xs_untypedAtomic', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
%% {{qname, ?NS, ?PX, <<"dateTimeStamp">>}, {xqSeqType, 'xs:dateTimeStamp', zero_or_one}, [], 
%%  {'xs_dateTimeStamp', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"NMTOKENS">>}, {xqSeqType, 'xs:NMTOKENS', zero_or_one}, [], 
 {'xs_NMTOKENS', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"ENTITIES">>}, {xqSeqType, 'xs:ENTITIES', zero_or_one}, [], 
 {'xs_ENTITIES', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"IDREFS">>}, {xqSeqType, 'xs:IDREFS', zero_or_one}, [], 
 {'xs_IDREFS', 2}, 1, [{xqSeqType, 'xs:anyAtomicType', zero_or_one}]}, 
{{qname, ?NS, ?PX, <<"error">>}, {xqSeqType, 'xs:error', zero_or_one}, [], 
