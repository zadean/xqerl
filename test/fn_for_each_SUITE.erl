...
environment('names') ->
[{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/higherOrder/names.xml","",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/for-each.xml"}]},
{params, []},
{namespaces, []},
{resources, []},
{modules, []}
...
'for-each-006'(_Config) ->
   Qry = "
        ...
        ",
   Env = xqerl_test:handle_environment([{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/higherOrder/doc1.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
