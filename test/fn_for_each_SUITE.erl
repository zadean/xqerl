...
environment('names') ->
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/fn/higherOrder/names.xml","",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
'for-each-006'(_Config) ->
   Qry = "
        ...
        ",
   Env = xqerl_test:handle_environment([{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/fn/higherOrder/doc1.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
