...
environment('names') ->
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/higherOrder/names.xml","",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/for-each.xml"}]},
{params, []},
{vars, []},
{namespaces, []},
{resources, []},
...
'for-each-005'(_Config) ->
   Qry = "
        ...
        ",
   {Env,Opts} = xqerl_test:handle_environment(environment('names')),
...
{sources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/higherOrder/doc1.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/for-each.xml"}]},
{vars, []},
