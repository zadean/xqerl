...
, try  xqerl:compile("C:/git/zadean/xquery-3.1/QT3-test-suite/app/Walmsley/strings.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xquery-3.1/QT3-test-suite/app/Walmsley/lib2.xqm") catch _:_ -> ok end,Config.
all() -> [
   'd1e11215',
   'd1e13012',
   'd1e13030',
