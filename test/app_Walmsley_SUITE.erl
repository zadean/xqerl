...
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/app/Walmsley/strings.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/app/Walmsley/lib2.xqm") catch _:_ -> ok end,Config.
all() -> [
   'd1e11215',
   'd1e13012',
   'd1e13030',
...
environment('all') ->
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xqerl/test/QT3-test-suite/app/Walmsley/catalog.xml",".","http://www.w3.org/2010/09/qt-fots-catalog/Walmsley/catalog.xml"},
{"C:/git/zadean/xqerl/test/QT3-test-suite/app/Walmsley/render.xsl","","http://www.w3.org/2010/09/qt-fots-catalog/Walmsley/render.xsl"}]},
{schemas, []},
{collections, []},
...
{namespaces, [{"http://www.w3.org/2005/xpath-functions/array","array"},
{"http://www.w3.org/2005/xpath-functions/map","map"}]},
{resources, [{"C:/git/zadean/xqerl/test/QT3-test-suite/app/Walmsley/product.json","http://www.w3.org/2010/09/qt-fots-catalog/Walmsley/product.json"}]},
{modules, []}
].
'd1e11215'(_Config) ->
