...
'fn-avgflt2args-1'(_Config) ->
 ...
 case ( begin Tst2 = xqerl:run("-3.4028235E38"),
  ...
  ResVal2 == TstVal2 end) orelse (xqerl_types:string_value(Res) == "-INF") orelse (is_tuple(Res) andalso element(1,Res) == 'xqError' andalso element(4,element(2,Res)) == "FOAR0002") of true -> {comment, "any-of"};
...
'fn-avg-mix-args-047'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_types:string_value(Res) == "NaN") orelse (is_tuple(Res) andalso element(1,Res) == 'xqError' andalso element(4,element(2,Res)) == "FORG0006") of true -> {comment, "any-of"};
   Q -> ct:fail(['any-of', {Res,Exp,Q}]) end.
