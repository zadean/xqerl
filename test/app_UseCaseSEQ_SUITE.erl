...
environment('report1') ->
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/docs/report1.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/app/UseCaseSEQ.xml"}]},
{params, []},
{vars, []},
{namespaces, []},
{resources, []},
...
'seq-queries-results-q1'(_Config) ->
   ...
   {Env,Opts} = xqerl_test:handle_environment(environment('report1')),
