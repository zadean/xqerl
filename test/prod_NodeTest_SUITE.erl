...
'NodeTest001'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<!-- this file is a copy of bib.xml; just adds a few comments and PI nodes for testing --><!-- Comment 1 --><!-- Comment 2 -->"++"</x>)")) == "true" of
...
'NodeTest002'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<?PI1 Processing Instruction 1?><?PI2 Processing Instruction 2?>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'NodeTest006'(_Config) ->
   ...
   Exp = "
         <result>CITI</result>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<result>CITI</result>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'NodeTest007-1'(_Config) ->
   ...
   Exp = "
         <out>0</out>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out>0</out>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'NodeTest007-2'(_Config) ->
   ...
   Exp = "
         <out>4</out>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out>4</out>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'NodeTest008-2'(_Config) ->
   ...
   Exp = "
         <out>6</out>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out>6</out>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'NodeTest009-2'(_Config) ->
   ...
   Exp = "
         <out>1</out>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out>1</out>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'NodeTest010-2'(_Config) ->
   ...
   Exp = "
         <out>7</out>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out>7</out>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'NodeTesthc-3'(_Config) ->
   ...
   Exp = "
         <result>false</result>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<result>false</result>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-NodeTest-41'(_Config) ->
   ...
   Exp = "
         <b name=\"D\"/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<b name=\"D\"/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
