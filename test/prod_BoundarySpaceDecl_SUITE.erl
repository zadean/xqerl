...
'boundary-space-003'(_Config) ->
   ...
   Exp = "
         <a> z abc</a>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<a> z abc</a>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
c
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<res>
a
b
c
</res>"++"</x>)")) == "true" of
...
<A>  A   {\"B\"}   C   {\"D\"}  </A>",
   ...
   Exp = "
         <A>  A   B   C   D</A>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<A>  A   B   C   D</A>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
<A> (a), (b), (c) </A>",
   ...
   Exp = "
         <A> (a), (b), (c) </A>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<A> (a), (b), (c) </A>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
