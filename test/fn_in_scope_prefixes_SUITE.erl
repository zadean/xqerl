...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "in-scope-prefixes/NamespaceSuppliedInternally.xml"), ".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "path/pathdata.xml"), ".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "in-scope-prefixes/namespaces11.xml"), ".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
