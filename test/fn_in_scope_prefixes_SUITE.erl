...
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/in-scope-prefixes/NamespaceSuppliedInternally.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/in-scope-prefixes.xml"}]},
{params, []},
{vars, []},
{namespaces, []},
{resources, []},
...
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/path/pathdata.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/in-scope-prefixes.xml"}]},
{params, []},
...
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/in-scope-prefixes/namespaces11.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/in-scope-prefixes.xml"}]},
{params, []},
...
'fn-in-scope-prefixes-25'(_Config) ->
   Qry = "in-scope-prefixes(/*)",
   {Env,Opts} = xqerl_test:handle_environment(environment('NamespaceSuppliedInternally')),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
   Res = try xqerl:run(Qry1,Opts) of D -> D catch _:E -> E end,
...
'fn-in-scope-prefixes-26'(_Config) ->
   ...
   {Env,Opts} = xqerl_test:handle_environment(environment('pathdata')),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
   Res = try xqerl:run(Qry1,Opts) of D -> D catch _:E -> E end,
   Out =    case xqerl_test:assert_string_value(Res, "xml") of 
