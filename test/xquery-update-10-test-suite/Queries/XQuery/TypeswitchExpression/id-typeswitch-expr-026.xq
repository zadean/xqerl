(: Name: id-typeswitch-expr-026 :)
(: Description: Evaluation of a rename expression used with typeswitch expression where a branch (the "default") is an updating expression. :)
