<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:test="http://www.w3.org/2005/02/query-test-update">
   ...
   <xsl:template match="/">
      <html>
         <head>
            <title>XQuery Update Interoperability Test Suite</title>
         </head>
         <body>
            ...
            <xsl:if test="not( test:test-suite/@targetLanguage )">
               <h1>XQuery Update Interoperability Test Suite</h1>
            </xsl:if>
            ...
            <h2>Introduction</h2>
            <P>
               The following document is an XSLT transform of the XQuery Testing Task Force (XQTTF) test catalog for the update Facility. The test 
               catalog is an XML file containing meta-data about the XQuery update interoperability 
               ...
               homepage at <A HREF="http://www.w3.org/XML/Query/Update/test-suite/">http://www.w3.org/XML/Query/Update/test-suite/</A>.
            </P>
            <h2>Citations</h2>
            <table>
               <tr>
