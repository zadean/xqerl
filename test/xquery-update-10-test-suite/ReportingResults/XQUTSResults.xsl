...
<xsl:stylesheet
   ...
   <xsl:template match="/">
      ...
      <html xmlns="http://www.w3.org/1999/xhtml">
         <head>
            <title>
               <xsl:text>XQuery Update Test Suite Result Summary</xsl:text>
         ...
         <body>
            ...
            <blockquote>
               <p>
                  ...
                  <a href="http://dev.w3.org/2007/xquery-update-10-test-suite/">XML Query Update Test Suite</a>
                  on one or more implementaions of the XQuery Update Facility.
               </p>
               
               <p>
                  <xsl:text>The latest version of this test suite is XQuery Update Test Suite </xsl:text>
