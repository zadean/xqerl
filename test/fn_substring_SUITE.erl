...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/fn/substring/concepts.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
'fn-substring-1'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case xqerl_types:string_value(Res) == " car" andalso xqerl_types:type(Res) == 'xs:string' of true -> {comment, "any-of"};
