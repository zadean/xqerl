    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-length-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-length-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-length-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-from-octets-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-from-octets-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-from-octets-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-from-octets-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-from-octets-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-from-octets-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-from-octets-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-from-octets-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-to-octets-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-to-octets-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-to-octets-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-to-octets-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-hex-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-hex-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-hex-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-hex-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-hex-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-hex-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-hex-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-hex-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-hex-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-hex-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bin-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bin-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bin-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bin-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bin-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bin-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bin-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bin-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bin-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bin-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-octal-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-octal-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-octal-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-octal-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-octal-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-octal-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-octal-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-octal-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-octal-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-octal-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-part-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-part-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-part-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-part-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-part-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-part-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-part-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-part-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-part-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-part-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-part-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-part-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-join-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-join-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-join-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-join-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-join-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-join-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case
            lists:any(
                ...
                [
                    case
                        xqerl_test:assert_error(Res, "Q{http://www.w3.org/2005/xqt-errors}FORG0006")
                    of
                        true ->
                            {comment, "Correct error"};
                        {true, F} ->
                            {comment,
                                "WE: Q{http://www.w3.org/2005/xqt-errors}FORG0006 " ++
                                    binary_to_list(F)};
                        {false, F} ->
                            F
                    end,
                    case
                        xqerl_test:assert_error(Res, "Q{http://www.w3.org/2005/xqt-errors}XPTY0004")
                    of
                        true ->
                            {comment, "Correct error"};
                        {true, F} ->
                            {comment,
                                "WE: Q{http://www.w3.org/2005/xqt-errors}XPTY0004 " ++
                                    binary_to_list(F)};
                        {false, F} ->
                            F
                    end
...
'EXPath-binary-insert-before-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-insert-before-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-insert-before-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-insert-before-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-insert-before-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-insert-before-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-insert-before-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-insert-before-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-insert-before-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-insert-before-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-insert-before-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-insert-before-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-left-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-left-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pad-right-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pad-right-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-find-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-find-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-find-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-find-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-find-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-find-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-find-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-find-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-find-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-find-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-find-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-find-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-find-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-find-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-encode-string-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-encode-string-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-encode-string-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-encode-string-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(65,195,170,195,177,195,188,67)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-encode-string-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-encode-string-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"feff011e\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-encode-string-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-encode-string-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-encode-string-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-011.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-012.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-013.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-014.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-015.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-decode-string-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-decode-string-016.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-002'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        " for $b in bin:pack-integer(34567,3,'most-significant-first') return $b eq\n"
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-003'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        " for $b in bin:pack-integer(34567,3,'least-significant-first') return $b eq\n"
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-004'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        " bin:pack-integer(34567,3,'most-significant-first') eq\n"
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-011.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-012.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-013.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(1,5)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-integer-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-014.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-integer-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-015.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(5,1,1)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-integer-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-016.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(1,1,5)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-integer-017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-017.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(5,1,1,1)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-integer-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-018.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(1,1,1,5)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-integer-019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-019.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(5,1,1,1,1,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-integer-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-020.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(0,0,0,1,1,1,1,5)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-integer-021'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-integer-021.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(0, 0, 0, 0, 0, 0, 11, 58, 115, 206, 47, 242)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-double-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-double-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(0,0,0,0,0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(128,0,0,0,0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(0,0,0,0,0,0,240,63)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(63,240,0,0,0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert_eq(
                            Res,
                            "xs:base64Binary(xs:hexBinary('3ff0000000000000'))"
                        )
                    of
                        true -> {comment, "Equal"};
                        {false, F} -> F
...
'EXPath-binary-pack-double-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(64,0,0,0,0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(127,240,0,0,0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(255,240,0,0,0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-double-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-double-011.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(127,248,0,0,0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-float-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-pack-float-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(0,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(128,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(0,0,128,63)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(63,128,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(64,0,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(127,128,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(255,128,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-pack-float-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-pack-float-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(127,192,0,0)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-unpack-double-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-double-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-double-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-float-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-float-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-002'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        " for $b in bin:unpack-unsigned-integer($int.short.B,0,2,'most-significant-first')\n"
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-003'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        " for $b in bin:unpack-unsigned-integer($int.short.B,0,2,'least-significant-first')\n"
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-004'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        " bin:unpack-unsigned-integer($int.short.B,0,2,'most-significant-first') eq\n"
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-011.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-unsigned-integer-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-unsigned-integer-012.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-004'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        " bin:unpack-integer($int.short.B,0,2,'most-significant-first') eq\n"
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-011.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-012.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-013.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-014.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-unpack-integer-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-unpack-integer-015.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-or-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-or-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-or-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-or-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-or-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-or-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-or-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-or-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-or-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-or-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-or-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-or-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-and-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-and-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-and-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-and-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-and-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-and-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-and-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-and-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-and-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-and-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-and-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-and-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-xor-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-xor-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-xor-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-xor-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-xor-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-xor-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-xor-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-xor-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-xor-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-xor-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-xor-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-xor-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-not-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-not-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-not-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-not-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-001.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"E01E\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"00F0\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"0F00\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"1E00\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"F000\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"7807\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-011.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-012.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-013.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"0078\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-014.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "xs:hexBinary(\"000F\")") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'EXPath-binary-bitwise-shift-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-015.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'EXPath-binary-bitwise-shift-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "EXPath-binary-bitwise-shift-016.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
