...
'Constr-pi-content-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<?pi content?>") of
...
'Constr-pi-content-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-pi-content-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<?pi ?>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-pi-content-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-pi-content-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<?pi <?&--&lt;&#x20;><![CDATA[x]]> ?>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-pi-content-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<pi>120</pi>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-pi-content-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<pi>120 32</pi>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-pi-content-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-content-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-pi-target-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-target-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-pi-target-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-target-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-pi-target-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-target-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-pi-target-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-pi-target-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-comment-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<!--comment-->") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-comment-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-comment-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<!---->") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-comment-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-comment-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<!--<?&-&lt;&#x20;><![CDATA[x]]>-->") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-comment-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-comment-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-comment-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-comment-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-DirectConOther-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "xmlSUFFIX") of
...
'K2-DirectConOther-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "PREFIXxml") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "PREFIXxmlSUFFIX") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<?target {1 + 1}?>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e>a<!--data tar-->b</e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<!-- <<<>><&%(/?=(=)&entity;-]]> -->") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<?target ]]>?>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                {file, filename:join(__BaseDir, "DirectConstructor/K2-DirectConOther-49.out")}
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'K2-DirectConOther-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                {file, filename:join(__BaseDir, "DirectConstructor/K2-DirectConOther-52.out")}
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'K2-DirectConOther-53'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-53.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                {file, filename:join(__BaseDir, "DirectConstructor/K2-DirectConOther-53.out")}
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'K2-DirectConOther-54'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-54.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                {file, filename:join(__BaseDir, "DirectConstructor/K2-DirectConOther-54.out")}
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'K2-DirectConOther-55'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-55.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-56'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-56.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-57.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-58'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-58.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e attr=\"   a\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-59.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-60'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-60.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e attr=\"    \"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-61'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-61.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-62'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-62.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-63'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-63.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-64'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-64.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-65'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-65.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-66'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-66.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-67'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-67.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-68'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-68.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<c b=\"a      string literal  \"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-69'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-69.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConOther-70'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-70.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "10 10 10 32 10 124 13 32 13 10") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConOther-71'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConOther-71.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<a xmlns:p=\"urn:abbrev:NS\"><b p:c=\"\" p:d=\"\"/></a>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
