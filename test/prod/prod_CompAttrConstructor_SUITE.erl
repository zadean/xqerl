...
'Constr-compattr-name-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-name-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"text\"/>") of
...
'Constr-compattr-name-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-name-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-name-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-name-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-name-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-name-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert(
                Res,
                "$result[self::x/@*[local-name()='y' and namespace-uri()='http://example.com/x']]"
            )
        of
...
'Constr-compattr-compname-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-4.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-compattr-compname-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem aQname=\"text\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-compattr-compname-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-compname-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-compname-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-doc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-doc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"texttext texttext\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-compattr-parent-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-parent-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-string-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-string-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-data-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-data-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-enclexpr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-enclexpr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-enclexpr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-enclexpr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-enclexpr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-enclexpr-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-enclexpr-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-enclexpr-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-id-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-id-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-compattr-id-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-compattr-id-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'constattrerr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "constattrerr-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-ComputeConAttr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<a><?target content?><b name=\"content\"/></a>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<a name=\"content\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<b name=\"content\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<b><elem/></b>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<b name=\"content\"><elem/></b>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<b n2=\"content\" name=\"content\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e name=\"\" name2=\"content\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e name=\"content\" name2=\"content\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e name=\"FF\" name2=\"content\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem name=\"content\"><alem/></elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "namespace-uri($result/@*:attr)=\"http://example.com/\""
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'K2-ComputeConAttr-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-53'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-53.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-54'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-54.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-55'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-55.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-56'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-56.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e xml:space=\"default\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-ComputeConAttr-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-57.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-58'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-58.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-59.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-60'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-60.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-ComputeConAttr-61'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ComputeConAttr-61.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'comp-attr-bad-name-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "comp-attr-bad-name-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'comp-attr-bad-name-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "comp-attr-bad-name-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'comp-attr-bad-name-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "comp-attr-bad-name-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'comp-attr-bad-name-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "comp-attr-bad-name-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'comp-attr-bad-name-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "comp-attr-bad-name-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'comp-attr-bad-name-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "comp-attr-bad-name-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'comp-attr-bad-name-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "comp-attr-bad-name-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-constr-compattr-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-constr-compattr-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<element attr=\"\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
