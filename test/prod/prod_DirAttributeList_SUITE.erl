...
'Constr-attr-syntax-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"value\"/>") of
...
'Constr-attr-syntax-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr1=\"val1\" attr2=\"val2\" attr3=\"val3\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-syntax-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-syntax-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"'\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-syntax-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-syntax-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-syntax-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-syntax-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr1=\"val1\" attr2=\"val2\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-syntax-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-syntax-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-syntax-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-parent-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-parent-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-nsdecl-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nsdecl-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-nsdecl-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nsdecl-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-nspre-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nspre-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-nspre-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nspre-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-nsprein-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nsprein-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-nsprein-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nsprein-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-nsprein-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nsprein-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<elem att=\"http://ns.example.com/uri\" xmlns:p=\"http://ns.example.com/uri\"/>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'Constr-attr-nsprein-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-nsprein-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-distnames-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-distnames-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-distnames-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-distnames-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-distnames-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-distnames-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-distnames-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-distnames-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-content-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-content-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-content-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-content-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-content-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-content-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-content-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-content-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-content-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-content-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-ws-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-attr-ws-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-attr-ws-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-attr-ws-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-attr-ws-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-attr-ws-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"&#xD;\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-ws-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-attr-ws-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-attr-ws-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-attr-ws-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-attr-entref-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-entref-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-entref-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-entref-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-charref-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-charref-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"012\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-enclexpr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"123 456 789\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"1  2\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-enclexpr-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"123456\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-enclexpr-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"12 34 56789\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"1 23\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem attr=\"zz\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-enclexpr-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-enclexpr-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e attr=\"abc23xyz\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-enclexpr-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-enclexpr-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-enclexpr-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-attr-enclexpr-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-attr-id-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-attr-id-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem xml:id=\"ncname\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-attr-id-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-attr-id-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-DirectConElemAttr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-4a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-4a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-6a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-6a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e attr=\"xa b c 1 2 3y\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, " content ") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "attr") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<foo attr=\"\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<foo attr=\" comment \"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<foo attr=\"dat a \"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<e xml:base=\"../\">http://example.com/level/file.ext</e>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'K2-DirectConElemAttr-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<e xml:base=\"http://example.com/2/2\">http://example.com/level/file.ext</e>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'K2-DirectConElemAttr-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e attr=\"fo\" a=\"bo\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<a b=\"1\" c=\"1\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-53'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-53.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-54'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-54.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-55'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-55.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-56'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-56.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-57.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-58'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-58.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-59.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-60'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-60.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-61'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-61.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-62'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-62.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-63'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-63.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-64'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-64.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-65'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-65.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-66'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-66.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-67'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-67.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-68'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-68.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-69'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-69.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-70'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-70.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-71'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-71.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-72'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-72.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-73'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-73.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemAttr-74'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-74.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e attr=\"1V1V\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemAttr-75'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-75.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                {file, filename:join(__BaseDir, "DirAttributeList/K2-DirectConElemAttr-75.out")}
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'K2-DirectConElemAttr-76'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemAttr-76.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<out fromFunction=\" [ 3 ] \" fromVariable=\" [ 3 ] \"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'DirectConElemAttr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "DirectConElemAttr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<shoe name=\" &#34;&#34; \"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'DirectConElemAttr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "DirectConElemAttr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
