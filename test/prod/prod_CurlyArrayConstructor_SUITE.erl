...
'CurlyArray-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "CurlyArray-002.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'CurlyArray-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "CurlyArray-004.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'CurlyArray-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "CurlyArray-006.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'CurlyArray-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "CurlyArray-008.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'CurlyArray-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "CurlyArray-010.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
