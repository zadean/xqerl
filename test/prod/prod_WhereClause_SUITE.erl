...
'WhereExpr001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr001.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<Same />") of
...
'WhereExpr002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr002.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr003.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr004.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr005.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr006.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr007.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr008.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr009.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr010.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr013.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr014.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr015.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr016.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr017.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr018.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr019.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr020a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr020a.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr022.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "File00000000000") of
...
'WhereExpr023'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr023.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr024.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr025'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr025.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr026'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr026.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr027'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr027.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'WhereExpr028'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr028.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'WhereExpr029'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr029.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'WhereExpr030'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr030.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'WhereExpr031'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr031.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'WhereExpr032'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr032.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'WhereExpr033'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "WhereExpr033.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "-2 -1 1 2") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'whereClause-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'whereClause-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "whereClause-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-WhereExpr-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-WhereExpr-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-WhereExpr-1b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-WhereExpr-1b.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-WhereExpr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-WhereExpr-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-hash-join-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-hash-join-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
            ...
            lists:any(
                ...
                [
                    ...
                    case xqerl_test:assert_error(Res, "XPST0004") of
                        true -> {comment, "Correct error"};
                        {true, F} -> {comment, "WE: XPST0004 " ++ binary_to_list(F)};
                        {false, F} -> F
                    end
                ]
            )
...
'cbcl-hash-join-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-hash-join-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-hash-join-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-hash-join-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2010-10-10 1997-01-02+12:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-hash-join-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-hash-join-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-hash-join-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "123 234") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-product-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-product-001.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-set-from-optional-item-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-set-from-optional-item-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-hash-join-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-hash-join-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1 1 3 3 5 5 7 7 9 9") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-hash-join-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-hash-join-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-hash-join-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-group-by-key-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-group-by-key-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-group-by-key-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-group-by-key-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-group-by-key-003'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "let $items := for $x in 1 to 100 return $x mod 10, $distinct-items := distinct-values($items) for $dist in $distinct-items return min( if ($dist = 0) then 0 else for $item in $items where $item = $dist return fn:round(1000 div $item))",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-group-by-key-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1000 500 333 250 200 167 143 125 111 0") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-group-by-key-004'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "let $items := for $x in 1 to 100 return $x mod 10, $distinct-items := distinct-values($items) for $dist in $distinct-items return min( for $item in $items where $item = $dist return if ($dist = 0) then 0 else fn:round(1000 div $item))",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-group-by-key-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-left-outer-join-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-left-outer-join-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-hash-join-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-map-concat-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-map-concat-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-map-concat-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-map-concat-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-map-concat-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-map-concat-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-left-outer-join-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-left-outer-join-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-left-outer-join-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-left-outer-join-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e><a>8</a><a>9</a><a>10</a></e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-left-outer-join-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-left-outer-join-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-hash-join-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-hash-join-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
