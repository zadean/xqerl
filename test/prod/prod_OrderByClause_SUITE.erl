...
'orderBy67'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderBy67.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "\"Bx\", \"Cy\", \"Az\"") of
...
'orderBy68'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderBy68.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-17.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-18.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-19.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-20.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-21.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-22.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-25.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-26.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-27.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-28.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-29.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-30.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-31.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-32.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-35.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-36.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-37.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-38.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-39.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-40.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-41.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-42.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-43.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-44.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-45.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-46.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-47.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-49.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-50.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-51.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-52.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-55'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-55.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-56'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-56.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-57.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-59.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbylocal-60'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbylocal-60.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-13.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-14.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-15.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-17.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-18.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-19.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-20.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-21.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-22.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-23.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-24.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-25.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-26.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-27.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-28.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-29.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-30.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-31.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-32.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-33.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-34.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-35.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-36.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-37.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-38.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-39.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'orderbywithout-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "orderbywithout-40.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1 2 2 2 3 2") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-OrderbyExprWithout-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1 3 2 1 3 2 1 3 2") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-OrderbyExprWithout-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "3 2 1 3 2 1 3 2 1") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-OrderbyExprWithout-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<result>2</result>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-OrderbyExprWithout-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "false false false true true true") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-OrderbyExprWithout-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "FO 1 FO 2 FO 3") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-OrderbyExprWithout-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-OrderbyExprWithout-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_string_value(Res, "NaN NaN NaN NaN 3 INF SEP 3 INF NaN NaN NaN NaN")
        of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
...
'K2-OrderbyExprWithout-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-OrderbyExprWithout-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
