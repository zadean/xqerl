    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'function-declaration-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'function-declaration-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-013.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-014.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-015.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-016.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'function-declaration-017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-017.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-018.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-019.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-020.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-021'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-021.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-022.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-023'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-023.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-024.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-025'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-025.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-026'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-026.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'function-declaration-028'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-028.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-029'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-029.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-declaration-030'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-declaration-030.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-12b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-12b.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-53'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-53.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-54'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-54.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-55'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-55.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-56'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-56.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-57.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-58'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-58.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-59.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-60'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-60.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-61'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-61.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-62'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-62.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-63'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-63.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-64'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-64.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-65'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-65.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-66'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-66.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-67'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-67.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-FunctionProlog-68'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-FunctionProlog-68.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e name2=\"\" name1=\"\" name0=\"\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-FunctionProlog-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "0 0 0 0 2 2 1 3") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-FunctionProlog-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "true true false false true") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-FunctionProlog-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "true false false false") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-FunctionProlog-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-FunctionProlog-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "testing ...") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-FunctionProlog-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-FunctionProlog-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-function-decl-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-function-decl-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-function-declaration-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-function-declaration-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "200000") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'function-decl-reserved-function-names-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-014.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-016.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-018.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-020.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-022.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-024.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-026'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-026.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-028'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-028.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-030'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-030.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'function-decl-reserved-function-names-032'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "function-decl-reserved-function-names-032.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
