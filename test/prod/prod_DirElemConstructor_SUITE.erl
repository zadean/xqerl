    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-empty-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-empty-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-empty-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-empty-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-empty-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-empty-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-empty-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-empty-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-empty-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-matchtag-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-matchtag-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-matchtag-2a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-matchtag-2a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-curlybr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-curlybr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-curlybr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-curlybr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-curlybr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-curlybr-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-curlybr-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-curlybr-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-curlybr-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-curlybr-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-elem-curlybr-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-elem-curlybr-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e>a</e><e>b</e><e>c</e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElem-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem>some text<node/>some text</elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElem-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<foo><doo/></foo>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElem-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<foo name=\"content\"><doo/></foo>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElem-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<p:e xmlns:p=\"http://www.example.com/\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElem-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e xml:id=\"fo\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElem-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<a>&#223;</a>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElem-53a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-53a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElem-54'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElem-54.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-directconelem-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-directconelem-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_string_value(
                Res,
                "xmlns:a=\"http://example.com/1\" xmlns:b=\"http://example.com/2\" xmlns:c=\"http://example.com/3\" xmlns:xml=\"http://www.w3.org/XML/1998/namespace\" | xmlns=\"http://example.com/0\" xmlns:c=\"http://example.com/3\" xmlns:xml=\"http://www.w3.org/XML/1998/namespace\""
            )
        of
            true -> {comment, "String correct"};
            {false, F} -> F
...
'cbcl-directconelem-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-directconelem-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
