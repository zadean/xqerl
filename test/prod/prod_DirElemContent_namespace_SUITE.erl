    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem xmlns:foo=\"http://www.example.com\"/>") of
...
'Constr-namespace-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem xmlns=\"http://www.example.com\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<foo:child xmlns:foo=\"http://www.example.com\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<foo:elem xmlns:foo=\"http://www.example.com/element\"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'Constr-namespace-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<foo:child xmlns:foo=\"http://www.example.com/parent\"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'Constr-namespace-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<child xmlns=\"http://www.example.com\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem xmlns=\"http://www.example.com/element\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<grand-child xmlns=\"http://www.example.com/child\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<child xmlns=\"http://www.example.com/element\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-namespace-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-26.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem xmlns:cm=\"http://www.example.com\">1</elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-27.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem xmlns:cm=\"http://www.example.com\" attr=\"1\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-namespace-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-29.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-namespace-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-namespace-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<e xmlns:p=\"http://www.w3.org/2005/xpath-functions\" a=\"0\"/>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'K2-DirectConElemNamespace-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<e xmlns=\"http://www.w3.org/2001/XMLSchema\" a=\"true\"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'K2-DirectConElemNamespace-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<e xmlns=\"http://www.w3.org/2001/XMLSchema\" a=\"1\"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'K2-DirectConElemNamespace-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e xmlns=\"http://www.example.com/\" a=\"data\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<e xmlns:p=\"http://www.w3.org/2001/XMLSchema\"><b/>1</e>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'K2-DirectConElemNamespace-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<e xmlns:p=\"http://www.w3.org/2001/XMLSchema\" a=\"1\"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'K2-DirectConElemNamespace-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<a xmlns:p=\"http://www.example.com/\" attr=\"3\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<p:e xmlns:p=\"http://example.com/\"/>2") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "START  A B xml END") of
...
'K2-DirectConElemNamespace-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e xmlns:p=\"http://www.example.com/\"><e/></e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e xmlns=\"http://www.example.com/\"><e/></e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e xmlns:p=\"http://example.com\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<anElement xmlns=\"http://www.example.com/B\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<a xmlns=\"http://example.com/\"><e xmlns=\"\"/></a>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-53'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-53.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-54'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-54.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-55'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-55.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-56'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-56.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-57.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<r xmlns=\"http://example.com/\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemNamespace-58'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-58.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-59.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-61'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-61.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-62'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-62.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-63'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-63.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-64'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-64.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-65'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-65.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-67'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-67.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-68'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-68.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-69'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-69.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-70'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-70.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-71'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-71.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-72'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-72.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-73'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-73.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-74'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-74.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-75'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-75.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-76'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-76.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-77'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-77.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-78'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-78.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemNamespace-79'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemNamespace-79.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'DirectConElemNamespace-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "DirectConElemNamespace-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'DirectConElemNamespace-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "DirectConElemNamespace-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            lists:any(
                ...
                [
                    case
                        xqerl_test:assert_string_value(Res, "http://ns.example.com/ns?val=\"asd")
                    of
                        true -> {comment, "String correct"};
                        {false, F} -> F
                    end,
...
'DirectConElemNamespace-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "DirectConElemNamespace-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'DirectConElemNamespace-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "DirectConElemNamespace-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-inscope-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-1.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-2.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-inscope-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-inscope-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-5.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-6.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-inscope-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-inscope-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-9.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-10.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-inscope-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-inscope-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-13.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<new/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-inscope-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-14.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<foo:new xmlns:foo=\"http://example.com\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-inscope-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-15.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<xml:new/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-inscope-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<new xml:attr=\"foo\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-inscope-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-17.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-18.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-19.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-20.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-inscope-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-21.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<a t='cat:miau'>42</a>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-inscope-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-inscope-22.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-ConInScopeNamespace-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-ConInScopeNamespace-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "xml xml xml xml") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
