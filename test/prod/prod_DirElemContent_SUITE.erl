...
environment('namespace-sensitive', __BaseDir) ->
    [
        ...
        {namespaces, []},
        {schemas, [
            {filename:join(__BaseDir, "DirElemContent/namespace-sensitive.xsd"),
                "http://www.example.com/test/namespace-sensitive"}
        ]},
        {resources, []},
        {modules, []}
    ].
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-invalid-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-invalid-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-invalid-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-invalid-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-invalid-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-invalid-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-invalid-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-eol-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-cont-eol-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<codepoints>49 10 50</codepoints>") of
...
'Constr-cont-eol-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-cont-eol-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'Constr-cont-eol-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-cont-eol-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<codepoints>13 10</codepoints>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-eol-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-cont-eol-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<codepoints>13</codepoints>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-entref-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-entref-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-entref-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-entref-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "62") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-entref-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-entref-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-entref-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-entref-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-entref-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-entref-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-charref-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-charref-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-charref-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-charref-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-cdata-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-cdata-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem>cdata&amp;&lt;&gt;'\"&amp;lt;&amp;#x20;</elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-text-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-text-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-text-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-text-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-nested-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nested-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem><a><b/></a><a/><c/></elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-nested-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nested-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem><?pi ?><?pi content?></elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-nested-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nested-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem><!----><!--content--></elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-nested-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nested-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-enclexpr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-enclexpr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-enclexpr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-enclexpr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-enclexpr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-enclexpr-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-enclexpr-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-enclexpr-4.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-enclexpr-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-enclexpr-5.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-nested-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nested-5.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-nodeid-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nodeid-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-nodeid-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nodeid-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-nodeid-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nodeid-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-nodeid-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nodeid-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-nodeid-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nodeid-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-nsmode-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nsmode-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-nsmode-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nsmode-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<z xmlns:inherit=\"http://www.example.com/inherit\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-nsmode-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nsmode-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<z xmlns:preserve=\"http://www.example.com/preserve\"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'Constr-cont-nsmode-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-nsmode-4.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<z/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-uripres-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-uripres-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "http://www.example.com/base2") of
...
'Constr-cont-adjtext-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-adjtext-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-adjtext-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-adjtext-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-adjtext-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-adjtext-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-adjtext-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-adjtext-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-doc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "Constr-cont-doc-1.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'Constr-cont-attr-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-attr-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-attr-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem mark=\"w0\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-attr-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-4.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-baseuri-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-baseuri-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-baseuri-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-baseuri-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-baseuri-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-baseuri-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-parent-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-parent-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-attr-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-5.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-attr-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-6.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case
            xqerl_test:assert_xml(Res, "<elem mark=\"w0\" west-attr-1=\"w1\" west-attr-2=\"w2\"/>")
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
...
'Constr-cont-attr-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-7.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-attr-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-8.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'Constr-cont-attr-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-attr-9.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem west-attr-1=\"w1\" west-attr-2=\"w2\"/>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'Constr-cont-string-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-string-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-data-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-data-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-document-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-document-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-document-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-document-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-document-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-document-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
            ...
            lists:all(
                ...
                [
                    case
                        xqerl_test:assert(
                            Res,
                            "sum($result//r/text()/string-length()) = count((9, 10, 13, 32 to 55295, 57344 to 65532, 65536 to 1114111 ))"
                        )
                    of
...
'Constr-cont-document-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-document-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Constr-cont-document-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Constr-cont-document-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, " (: an (:example:) ") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-26a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-26a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem>contentcontent</elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-26b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-26b.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e>1A1</e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1A1") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-35b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-35b.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem>12345</elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem>1234</elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<elem>123</elem>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e>12</e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K2-DirectConElemContent-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-DirectConElemContent-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-DirectConElemContent-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-ns-fixup-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-ns-fixup-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'ElemContentArray-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "ElemContentArray-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e>1 2 3</e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'ElemContentArray-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "ElemContentArray-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_xml(Res, "<e><f>1<x/>3</f><g>4<x/>5</g></e>") of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
        end,
    case Out of
