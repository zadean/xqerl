...
{sources, [{"file:///C:/git/zadean/xqerl/test/QT3-test-suite/prod/AxisStep.preceding/SmallTree.xml",".",""}]},
{schemas, []},
{collections, []},
...
'preceding-23'(_Config) ->
   ...
   {Env,Opts} = xqerl_test:handle_environment([{'decimal-formats', []},
{sources, [{"file:///C:/git/zadean/xqerl/test/QT3-test-suite/prod/AxisStep.preceding/AttributesAndElements.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"file:///C:/git/zadean/xqerl/test/QT3-test-suite/prod/"}]},
{vars, []},
