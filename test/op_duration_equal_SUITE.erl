...
'distinct-duration-equal-1'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_types:string_value(Res) == "P0M") orelse (xqerl_types:string_value(Res) == "PT0S") of true -> {comment, "any-of"};
...
'distinct-duration-equal-2'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_types:string_value(Res) == "P1Y P365D") orelse (xqerl_types:string_value(Res) == "P365D P1Y") of true -> {comment, "any-of"};
   Q -> ct:fail(['any-of', {Res,Exp,Q}]) end.
