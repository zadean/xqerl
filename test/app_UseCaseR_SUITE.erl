...
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/docs/users.xml","$users",""},
{"C:/git/zadean/xquery-3.1/QT3-test-suite/docs/items.xml","$items",""},
{"C:/git/zadean/xquery-3.1/QT3-test-suite/docs/bids.xml","$bids",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/app/UseCaseR.xml"}]},
{params, []},
{vars, []},
{namespaces, []},
{resources, []},
