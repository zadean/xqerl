...
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xqerl/test/QT3-test-suite/docs/users.xml","$users",""},
{"C:/git/zadean/xqerl/test/QT3-test-suite/docs/items.xml","$items",""},
{"C:/git/zadean/xqerl/test/QT3-test-suite/docs/bids.xml","$bids",""}]},
{schemas, []},
{collections, []},
