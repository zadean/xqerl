...
'y_array_empty-string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_empty-string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert(Res, "count($result) lt 2") of
...
'n_number_minus_sign_with_trailing_garbage'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_minus_sign_with_trailing_garbage.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_with_single_string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_with_single_string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_too_big_pos_int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_too_big_pos_int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_null_escape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_null_escape.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_overlong_sequence_6_bytes'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_overlong_sequence_6_bytes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_array_null.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_object_missing_value'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_missing_value.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_incomplete_surrogates_escape_valid'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_incomplete_surrogates_escape_valid.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_object_close_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_object_close_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_real_pos_overflow'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_real_pos_overflow.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_lone_utf8_continuation_byte'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_lone_utf8_continuation_byte.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_-2.'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_-2..xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_unclosed_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_unclosed_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_escape_x'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_string_escape_x.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'i_string_UTF-16LE_with_BOM'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_UTF-16LE_with_BOM.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_invalid-utf-8-in-bigger-int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_invalid-utf-8-in-bigger-int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_invalid-utf-8-in-exponent'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_invalid-utf-8-in-exponent.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_1_2_3_bytes_UTF-8_sequences'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_1_2_3_bytes_UTF-8_sequences.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_single_space'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_single_space.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_number_real_exponent'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_real_exponent.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_real_neg_overflow'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_real_neg_overflow.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_object.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'i_string_iso_latin_1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_iso_latin_1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_unquoted_key'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_unquoted_key.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_a_invalid_utf8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_a_invalid_utf8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_minus_zero'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_minus_zero.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_several_trailing_commas'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_several_trailing_commas.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_double_close_to_zero'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_double_close_to_zero.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_single_eacute'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_single_eacute.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_object_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_object_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_allowed_escapes'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_allowed_escapes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_just_minus'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_just_minus.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_empty'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_array_empty.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_open_object_open_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_object_open_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_invalid_unicode_escape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_invalid_unicode_escape.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_9.e+'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_9.e+.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_string_incomplete_escape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_incomplete_escape.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_string_empty'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_string_empty.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object_empty'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_object_empty.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_string_pi'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_string_pi.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_unclosed_array_unfinished_false'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_unclosed_array_unfinished_false.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_escaped_noncharacter'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_escaped_noncharacter.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_with_leading_zero'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_with_leading_zero.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_int_with_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_int_with_exp.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_1.0e+'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_1.0e+.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_number_-NaN'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_-NaN.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_string_unescaped_tab'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_unescaped_tab.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_ascii-unicode-identifier'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_ascii-unicode-identifier.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_incomplete_surrogate'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_incomplete_surrogate.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_items_separated_by_semicolon'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_items_separated_by_semicolon.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_invalid_surrogate'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_invalid_surrogate.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_infinity'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_infinity.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_comma_instead_of_closing_brace'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_comma_instead_of_closing_brace.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object_duplicated_key_and_value'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_duplicated_key_and_value.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_with_trailing_garbage'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_with_trailing_garbage.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_0.1.2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_0.1.2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_string_last_surrogates_1_and_2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_last_surrogates_1_and_2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_accepted_surrogate_pair'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_accepted_surrogate_pair.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_1st_valid_surrogate_2nd_invalid'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_1st_valid_surrogate_2nd_invalid.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_lonely_false'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_lonely_false.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_uescaped_LF_before_string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_uescaped_LF_before_string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_real_capital_e_pos_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_real_capital_e_pos_exp.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_Inf'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_Inf.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_array_incomplete'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_incomplete.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_object_key_lone_2nd_surrogate'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_object_key_lone_2nd_surrogate.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_utf16BE_no_BOM'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_utf16BE_no_BOM.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicode'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_string_unicode.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_string_accentuated_char_no_quotes'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_accentuated_char_no_quotes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_true_in_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_true_in_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_.2e-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_.2e-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_open_array_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_array_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicode_U+1FFFE_nonchar'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_U+1FFFE_nonchar.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_backslash_and_u_escaped_zero'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_backslash_and_u_escaped_zero.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_three-byte-utf-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_three-byte-utf-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_backslash_doublequotes'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_backslash_doublequotes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_missing_value'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_missing_value.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_trailing_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_trailing_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_two_commas_in_a_row'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_two_commas_in_a_row.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_no_data'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_no_data.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_single_star'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_single_star.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_uescaped_newline'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_uescaped_newline.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_invalid-negative-real'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_invalid-negative-real.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_lone-invalid-utf-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_lone-invalid-utf-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_incomplete_invalid_value'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_incomplete_invalid_value.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_0e'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_0e.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_number_invalid-utf-8-in-int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_invalid-utf-8-in-int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_invalid_utf8_after_escape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_invalid_utf8_after_escape.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_number_and_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_number_and_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_unclosed_object'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_unclosed_object.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_starting_with_dot'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_starting_with_dot.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_after_space'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_after_space.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_whitespace_formfeed'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_whitespace_formfeed.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_2.e3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_2.e3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_number_negative_one'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_negative_one.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_key_with_single_quotes'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_key_with_single_quotes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_U+FF11_fullwidth_digit_one'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_U+FF11_fullwidth_digit_one.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_lonely_int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_lonely_int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_unclosed_array_partial_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_unclosed_array_partial_null.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_huge_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "i_number_huge_exp.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_object_with_trailing_garbage'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_object_with_trailing_garbage.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_UTF8_surrogate_U+D800'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_UTF8_surrogate_U+D800.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_lonely_negative_real'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_lonely_negative_real.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_non_string_key'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_non_string_key.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_++'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_++.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_string_unicode_escaped_double_quote'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_escaped_double_quote.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_garbage_at_end'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_garbage_at_end.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_real_capital_e'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_real_capital_e.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_double_escape_a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_double_escape_a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_-01'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_-01.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_number_real_fraction_exponent'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_real_fraction_exponent.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_number_and_several_commas'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_number_and_several_commas.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_comments'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_string_comments.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_UTF8_BOM_no_data'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_UTF8_BOM_no_data.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_single_doublequote'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_single_doublequote.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_too_big_neg_int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_too_big_neg_int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_lonely_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_lonely_null.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_space'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_string_space.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_object_lone_continuation_byte_in_key_and_trailing_comma'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/n_object_lone_continuation_byte_in_key_and_trailing_comma.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(
                    __BaseDir,
                    "n_object_lone_continuation_byte_in_key_and_trailing_comma.xq"
                ),
                Qry1
            ),
            xqerl:run(Mod)
...
'y_string_uEscape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_string_uEscape.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_array_with_1_and_newline'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_with_1_and_newline.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_end_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_end_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_unicode_CapitalU'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_unicode_CapitalU.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_extra_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_extra_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_with_alpha_char'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_with_alpha_char.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_backslash_00'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_backslash_00.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_1st_surrogate_but_2nd_missing'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_1st_surrogate_but_2nd_missing.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_whitespace_U+2060_word_joiner'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_whitespace_U+2060_word_joiner.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_capitalized_True'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_capitalized_True.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_star_inside'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_star_inside.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_trailing_comment_slash_open'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_trailing_comment_slash_open.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_1_true_without_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_1_true_without_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_0e+1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_number_0e+1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_object_with_newlines'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_with_newlines.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_with_alpha'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_with_alpha.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_array_apostrophe'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_array_apostrophe.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_object_unclosed_no_value'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_object_unclosed_no_value.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_0_capital_E'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_0_capital_E.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_real_capital_e_neg_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_real_capital_e_neg_exp.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_incomplete_true'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_incomplete_true.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_array_double_extra_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_double_extra_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_lonely_string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_lonely_string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_+Inf'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_+Inf.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_number_hex_2_digits'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_hex_2_digits.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_close_unopened_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_close_unopened_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_comma_instead_of_colon'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_comma_instead_of_colon.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_object_string_with_apostrophes'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/n_structure_open_object_string_with_apostrophes.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_object_string_with_apostrophes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_negative_int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_negative_int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_inverted_surrogates_U+1D11E'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_inverted_surrogates_U+1D11E.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_object_with_comment'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_object_with_comment.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_incomplete_surrogate_escape_invalid'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/n_string_incomplete_surrogate_escape_invalid.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_incomplete_surrogate_escape_invalid.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_utf16LE_no_BOM'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_utf16LE_no_BOM.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_overlong_sequence_6_bytes_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_overlong_sequence_6_bytes_null.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_trailing_comment_open'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_trailing_comment_open.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_ending_with_newline'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_ending_with_newline.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_colon_instead_of_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_colon_instead_of_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_trailing_comment_slash_open_incomplete'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/n_object_trailing_comment_slash_open_incomplete.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_trailing_comment_slash_open_incomplete.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_simple_real'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_simple_real.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_2.e+3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_2.e+3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_array_unclosed_with_object_inside'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_unclosed_with_object_inside.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_array_trailing_garbage'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_array_trailing_garbage.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_truncated-utf-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_truncated-utf-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicode_U+200B_ZERO_WIDTH_SPACE'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_U+200B_ZERO_WIDTH_SPACE.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_double_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_double_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_u+2028_line_sep'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_u+2028_line_sep.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_neg_int_starting_with_zero'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_neg_int_starting_with_zero.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_newlines_unclosed'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_newlines_unclosed.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_lonely_true'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_lonely_true.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_missing_colon'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_missing_colon.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_two-byte-utf-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_two-byte-utf-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicodeEscapedBackslash'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicodeEscapedBackslash.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_overlong_sequence_2_bytes'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_overlong_sequence_2_bytes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_missing_semicolon'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_missing_semicolon.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object_simple'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_object_simple.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_string_unicode_U+2064_invisible_plus'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_U+2064_invisible_plus.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_minus_space_1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_minus_space_1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_unescaped_crtl_char'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_unescaped_crtl_char.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_escaped_control_character'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_escaped_control_character.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_simple_ascii'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_simple_ascii.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicode_U+10FFFE_nonchar'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_U+10FFFE_nonchar.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_object'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_object.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_utf8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_string_utf8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_string_escaped_ctrl_char_tab'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_escaped_ctrl_char_tab.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_double_huge_neg_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_double_huge_neg_exp.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_invalid+-'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_invalid+-.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_100000_opening_arrays'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_100000_opening_arrays.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_leading_uescaped_thinspace'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_leading_uescaped_thinspace.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_0.3e'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_0.3e.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_structure_lone-open-bracket'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_lone-open-bracket.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unescaped_char_delete'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unescaped_char_delete.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_object_followed_by_closing_object'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/n_structure_object_followed_by_closing_object.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_object_followed_by_closing_object.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_unicode-identifier'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_unicode-identifier.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_1eE2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_1eE2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_object_extreme_numbers'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_extreme_numbers.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_+1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_+1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_object_long_strings'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_long_strings.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_incomplete_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_incomplete_null.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_number_negative_zero'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_negative_zero.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_multidigit_number_then_00'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_multidigit_number_then_00.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_1_surrogate_then_escape_u'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_1_surrogate_then_escape_u.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_with_leading_space'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_with_leading_space.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_double_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_double_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_trailing_newline'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_trailing_newline.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_invalid_utf8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_invalid_utf8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_repeated_null_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_repeated_null_null.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_bad_value'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_bad_value.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_pos_double_huge_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_pos_double_huge_exp.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_surrogates_U+1D11E_MUSICAL_SYMBOL_G_CLEF'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/y_string_surrogates_U+1D11E_MUSICAL_SYMBOL_G_CLEF.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_surrogates_U+1D11E_MUSICAL_SYMBOL_G_CLEF.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object_string_unicode'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_string_unicode.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_no_quotes_with_bad_escape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_no_quotes_with_bad_escape.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_neg_with_garbage_at_end'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_neg_with_garbage_at_end.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_1_surrogate_then_escape_u1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_1_surrogate_then_escape_u1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_spaces_vertical_tab_formfeed'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_spaces_vertical_tab_formfeed.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_array_object'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_array_object.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_object_open_string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_object_open_string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_non_string_key_but_huge_number_instead'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/n_object_non_string_key_but_huge_number_instead.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_non_string_key_but_huge_number_instead.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_real_underflow'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_real_underflow.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_single_quote'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_single_quote.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_real_garbage_after_e'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_real_garbage_after_e.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_escaped_backslash_bad'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_escaped_backslash_bad.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_0e1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_number_0e1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_number_real_pos_exponent'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_real_pos_exponent.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_double_escape_n'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_double_escape_n.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_arraysWithSpaces'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_arraysWithSpaces.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_heterogeneous'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_heterogeneous.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_with_del_character'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_with_del_character.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_with_trailing_garbage'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_with_trailing_garbage.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_with_several_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_with_several_null.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_simple_int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_simple_int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_expression'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_expression.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_array_string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_array_string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_missing_key'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_missing_key.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_1_surrogate_then_escape_u1x'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_1_surrogate_then_escape_u1x.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_trailing_%23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_trailing_%23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_array_with_extra_array_close'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_array_with_extra_array_close.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object_empty_key'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_empty_key.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_nonCharacterInUTF-8_U+FFFF'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_nonCharacterInUTF-8_U+FFFF.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_very_big_negative_int'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_very_big_negative_int.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_invalid_lonely_surrogate'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_invalid_lonely_surrogate.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object_escaped_null_in_key'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_escaped_null_in_key.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_angle_bracket_.'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_angle_bracket_..xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_accepted_surrogate_pairs'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_accepted_surrogate_pairs.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_structure_500_nested_arrays'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_structure_500_nested_arrays.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_number_real_neg_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_number_real_neg_exp.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_structure_whitespace_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_structure_whitespace_array.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_in_array_with_leading_space'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_in_array_with_leading_space.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_nonCharacterInUTF-8_U+10FFFF'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_nonCharacterInUTF-8_U+10FFFF.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_bracket_key'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_bracket_key.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_number_neg_int_huge_exp'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_number_neg_int_huge_exp.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_NaN'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_NaN.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_string_single_string_no_double_quotes'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_single_string_no_double_quotes.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_neg_real_without_int_part'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_neg_real_without_int_part.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_unescaped_newline'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_unescaped_newline.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_with_trailing_space'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_array_with_trailing_space.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_not_in_unicode_range'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_not_in_unicode_range.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_single_quote'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_single_quote.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_1_000'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_1_000.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_object_duplicated_key'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_object_duplicated_key.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_incomplete_escaped_character'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_incomplete_escaped_character.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_no-colon'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_object_no-colon.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_string_one-byte-utf-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_one-byte-utf-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicode_2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_trailing_comment'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_trailing_comment.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicode_U+FDD0_nonchar'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_U+FDD0_nonchar.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_incomplete_false'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_incomplete_false.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_null-byte-outside-string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_null-byte-outside-string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_structure_UTF-8_BOM_empty_object'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_structure_UTF-8_BOM_empty_object.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_nbsp_uescaped'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_nbsp_uescaped.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_number_with_trailing_garbage'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_number_with_trailing_garbage.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_real_without_fractional_part'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_real_without_fractional_part.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_invalid_utf-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_invalid_utf-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_incomplete_surrogate_pair'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_incomplete_surrogate_pair.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_invalid_backslash_esc'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_invalid_backslash_esc.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_minus_infinity'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_minus_infinity.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_unclosed'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_array_unclosed.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'i_string_incomplete_surrogate_and_escape_valid'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "json-doc('JSONTestSuite/test_parsing/i_string_incomplete_surrogate_and_escape_valid.json')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_incomplete_surrogate_and_escape_valid.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_array_false'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_array_false.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_number_real_with_invalid_utf8_after_e'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_real_with_invalid_utf8_after_e.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_unicode_U+FFFE_nonchar'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_unicode_U+FFFE_nonchar.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_open'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_open.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_unclosed_trailing_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_unclosed_trailing_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_comma_and_number'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_comma_and_number.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_1_surrogate_then_escape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_1_surrogate_then_escape.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_unclosed_array_unfinished_true'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_unclosed_array_unfinished_true.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_escaped_emoji'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_escaped_emoji.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_comma_after_close'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_comma_after_close.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_reservedCharacterInUTF-8_U+1BFFF'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_reservedCharacterInUTF-8_U+1BFFF.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_U+2060_word_joined'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_U+2060_word_joined.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_0.e1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_0.e1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_array_unclosed_with_new_lines'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_unclosed_with_new_lines.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_angle_bracket_null'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_angle_bracket_null.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_emoji'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_object_emoji.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_object_unterminated-value'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_unterminated-value.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_array_with_unclosed_string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_array_with_unclosed_string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_u+2029_par_sep'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "y_string_u+2029_par_sep.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_object_double_colon'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_object_double_colon.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_object_basic'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_object_basic.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'i_string_lone_second_surrogate'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_lone_second_surrogate.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_array_open_string'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_array_open_string.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_extra_close'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_extra_close.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'i_string_UTF-8_invalid_sequence'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "i_string_UTF-8_invalid_sequence.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_array_inner_array_no_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_inner_array_no_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_start_escape_unclosed'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_start_escape_unclosed.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_string_invalid-utf-8-in-escape'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_string_invalid-utf-8-in-escape.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_open_array_open_object'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_open_array_open_object.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_number_hex_1_digit'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_number_hex_1_digit.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'n_structure_incomplete_UTF8_BOM'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_structure_incomplete_UTF8_BOM.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'y_string_in_array'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_string_in_array.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_number_-1.0.'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "n_number_-1.0..xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'y_number'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "y_number.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'n_array_just_comma'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "n_array_just_comma.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
