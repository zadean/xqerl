...
[{'decimal-formats', []},
{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/docs/partlist.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/prod/UnorderedExpr.xml"}]},
{params, []},
{namespaces, []},
{resources, []},
{modules, []}
