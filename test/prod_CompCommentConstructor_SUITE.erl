...
{schemas, []},
{collections, []},
{'static-base-uri', [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/prod/CompCommentConstructor.xml"}]},
{params, []},
{namespaces, []},
{resources, []},
{modules, []}
...
'Constr-compcomment-dash-4'(_Config) ->
   ...
   Env = xqerl_test:handle_environment([{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/prod/CompCommentConstructor.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
