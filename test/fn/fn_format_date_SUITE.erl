...
'format-date-001a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-001a.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-001b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-001b.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-001c'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-001c.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-001d'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-001d.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-001e'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-001e.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-001f'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-001f.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-001g'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-001g.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-005.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-006.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-007a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-007a.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "๒๐๐๓-๐๙-๗") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-007b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-007b.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "๙-๗-๒๐๐๓") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-007c'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-007c.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "(๐๓-๐๙-๐๗)") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-008a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-008a.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "𐒢𐒠𐒠𐒣-𐒠𐒩-𐒧") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-008b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-008b.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "𐒩-𐒧-𐒢𐒠𐒠𐒣") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-008c'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-008c.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "(𐒠𐒣-𐒠𐒩-𐒠𐒧)") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-009.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-010.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-011.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013a.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013b.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013c'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013c.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013d'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013d.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013e'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013e.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013f'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013f.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013g'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013g.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013h'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013h.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013i'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013i.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013j'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013j.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013k'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013k.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013L'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013L.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013m'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013m.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-013n'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-013n.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-014.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-015.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_norm_string_value(
                Res,
                "GMT-14; GMT-13:30; GMT-13; GMT-12:30; GMT-12; GMT-11:30; GMT-11; GMT-10:30; GMT-10; GMT-9:30; GMT-9; GMT-8:30; GMT-8; GMT-7:30; GMT-7; GMT-6:30; GMT-6; GMT-5:30; GMT-5; GMT-4:30; GMT-4; GMT-3:30; GMT-3; GMT-2:30; GMT-2; GMT-1:30; GMT-1; GMT-0:30; GMT+0; GMT+0:30; GMT+1; GMT+1:30; GMT+2; GMT+2:30; GMT+3; GMT+3:30; GMT+4; GMT+4:30; GMT+5; GMT+5:30; GMT+6; GMT+6:30; GMT+7; GMT+7:30; GMT+8; GMT+8:30; GMT+9; GMT+9:30; GMT+10; GMT+10:30; GMT+11; GMT+11:30; GMT+12; GMT+12:30; GMT+13; GMT+13:30; GMT+14"
            )
        of
            true -> {comment, "String correct"};
            {false, F} -> F
...
'format-date-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-016.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_norm_string_value(
                Res,
                "GMT-14:00; GMT-13:30; GMT-13:00; GMT-12:30; GMT-12:00; GMT-11:30; GMT-11:00; GMT-10:30; GMT-10:00; GMT-09:30; GMT-09:00; GMT-08:30; GMT-08:00; GMT-07:30; GMT-07:00; GMT-06:30; GMT-06:00; GMT-05:30; GMT-05:00; GMT-04:30; GMT-04:00; GMT-03:30; GMT-03:00; GMT-02:30; GMT-02:00; GMT-01:30; GMT-01:00; GMT-00:30; GMT+00:00; GMT+00:30; GMT+01:00; GMT+01:30; GMT+02:00; GMT+02:30; GMT+03:00; GMT+03:30; GMT+04:00; GMT+04:30; GMT+05:00; GMT+05:30; GMT+06:00; GMT+06:30; GMT+07:00; GMT+07:30; GMT+08:00; GMT+08:30; GMT+09:00; GMT+09:30; GMT+10:00; GMT+10:30; GMT+11:00; GMT+11:30; GMT+12:00; GMT+12:30; GMT+13:00; GMT+13:30; GMT+14:00"
            )
        of
            true -> {comment, "String correct"};
            {false, F} -> F
...
'format-date-017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-017.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-018.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "J") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-019.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "+05:30") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-020.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "+13:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-021'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-021.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-022.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "+٠٥:٣٠") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-023'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-023.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-024.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_norm_string_value(
                Res,
                "-1400; -1330; -1300; -1230; -1200; -1130; -1100; -1030; -1000; -930; -900; -830; -800; -730; -700; -630; -600; -530; -500; -430; -400; -330; -300; -230; -200; -130; -100; -030; +000; +030; +100; +130; +200; +230; +300; +330; +400; +430; +500; +530; +600; +630; +700; +730; +800; +830; +900; +930; +1000; +1030; +1100; +1130; +1200; +1230; +1300; +1330; +1400"
            )
        of
            true -> {comment, "String correct"};
            {false, F} -> F
...
'format-date-025'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-025.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_norm_string_value(
                Res,
                "-14; -13:30; -13; -12:30; -12; -11:30; -11; -10:30; -10; -09:30; -09; -08:30; -08; -07:30; -07; -06:30; -06; -05:30; -05; -04:30; -04; -03:30; -03; -02:30; -02; -01:30; -01; -00:30; +00; +00:30; +01; +01:30; +02; +02:30; +03; +03:30; +04; +04:30; +05; +05:30; +06; +06:30; +07; +07:30; +08; +08:30; +09; +09:30; +10; +10:30; +11; +11:30; +12; +12:30; +13; +13:30; +14"
            )
        of
            true -> {comment, "String correct"};
            {false, F} -> F
...
'format-date-026'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-026.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_norm_string_value(
                Res,
                "-14; -13:30; -13; -12:30; -12; -11:30; -11; -10:30; -10; -9:30; -9; -8:30; -8; -7:30; -7; -6:30; -6; -5:30; -5; -4:30; -4; -3:30; -3; -2:30; -2; -1:30; -1; -0:30; Z; +0:30; +1; +1:30; +2; +2:30; +3; +3:30; +4; +4:30; +5; +5:30; +6; +6:30; +7; +7:30; +8; +8:30; +9; +9:30; +10; +10:30; +11; +11:30; +12; +12:30; +13; +13:30; +14"
            )
        of
            true -> {comment, "String correct"};
            {false, F} -> F
...
'format-date-027'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-027.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "+𐒥:𐒣𐒠") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-028'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-028.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "18 05 2012") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-029'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-029.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2;012") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-030'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-030.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-031'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-031.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2,01-2") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-032'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-032.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1200") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-033'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-033.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "900") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-034'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-034.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "0000000000000000000002012") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-035'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-035.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "๐๐๐๐๐๐๒๐๑๒") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-036'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-036.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "32") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-037'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-037.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-038'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "format-date(xs:date('654321-01-01'), '[Y#0 ' || codepoints-to-string(10) || '00            0]')",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-038.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "54321") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-039'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-039.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-040'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-040.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-041'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-041.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1.6") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-042'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-042.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-043'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-043.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-044'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-044.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-045'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-045.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-046'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-046.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-047'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-047.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-048'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-048.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-801err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-802err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-802err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-803err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-803err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-804err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-804err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-805err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-805err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-806err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-806err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-807err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-807err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-808err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-808err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-809err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-809err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-810err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-810err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-en101'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en101.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en102'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en102.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en103'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en103.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en104'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en104.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en105'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en105.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en106'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en106.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en111'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en111.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en112'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en112.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en113'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en113.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en114'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en114.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "MON TUE WED THU FRI SAT SUN") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'format-date-en115'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en115.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en116'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en116.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en117'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en117.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en118'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en118.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en121'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en121.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en122'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en122.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_norm_string_value(
                Res,
                "1990th 1991st 1992nd 1993rd 1994th 1995th 1996th 1997th 1998th 1999th 2000th 2001st 2002nd 2003rd 2004th 2005th 2006th 2007th 2008th 2009th 2010th 2011th 2012th 2013th 2014th 2015th 2016th 2017th 2018th 2019th 2020th"
            )
        of
            true -> {comment, "String correct"};
            {false, F} -> F
...
'format-date-en122b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-en122b.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'format-date-en123'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en123.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en124'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en124.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en125'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en125.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en126'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en126.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en127'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en127.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en128'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en128.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en129'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en129.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en130'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en130.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en131'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en131.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en132'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en132.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en133'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en133.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en134'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en134.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en141'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en141.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en151'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en151.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en152'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en152.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en153'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en153.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en154'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en154.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'format-date-en155'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en155.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en156'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en156.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en157'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en157.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-en158'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "format-date-en158.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'format-date-inpt-er1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-inpt-er1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-inpt-er2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-inpt-er2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-inpt-er3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-inpt-er3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-inpt-er4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-inpt-er4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'format-date-1340err'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "format-date-1340err.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
