...
'fn-base-uri-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-13.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-14.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-15.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-17.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-18.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-19.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "http://www.examples.com") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-base-uri-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-20.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-21.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-22.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-23.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-24.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-25.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-26.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-27.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-28.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-29.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-30.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-31.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-32.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-33.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-34.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-35.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-36.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-37.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-38.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-39.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-40.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-41.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-42.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-base-uri-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-base-uri-43.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-BaseURIFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-BaseURIFunc-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-BaseURIFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-BaseURIFunc-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-13.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-14.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-15.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-17.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-18.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-19.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "http://www.example.com/xml") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-BaseURIFunc-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-20.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-21.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "xs:integer xs:anyURI xs:integer") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-BaseURIFunc-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-22.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-23.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-24.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-25.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-26.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-27.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "http://example.com/BASEURI") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-BaseURIFunc-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-28.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "Base URI: http://example.com/ Document URI:") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K2-BaseURIFunc-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-29.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-30.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-31.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-32.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-BaseURIFunc-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-BaseURIFunc-33.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "http://example.com/DEF/file.test") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-base-uri-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-base-uri-001.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "http://www.w3.org/TR/xquery") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-base-uri-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-base-uri-002.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-base-uri-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-base-uri-003.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-base-uri-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-base-uri-004.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
