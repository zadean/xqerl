    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "22:03:35-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "13:59:59-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "10:00:00-05:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "12:00:00-05:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "10:00:00-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "07:00:00-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "10:00:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "03:00:00+10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-time-to-timezone-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-adjust-time-to-timezone-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-time-to-timezone-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjTimeToTimezoneFunc-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjTimeToTimezoneFunc-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-adjust-time-to-timezone-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-adjust-time-to-timezone-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-adjust-time-to-timezone-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-adjust-time-to-timezone-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
