    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-default-collation-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-default-collation-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-default-collation-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-ContextDefaultCollationFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-ContextDefaultCollationFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-ContextDefaultCollationFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-ContextDefaultCollationFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-ContextDefaultCollationFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-ContextDefaultCollationFunc-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-default-collation-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-default-collation-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-default-collation-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-default-collation-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
