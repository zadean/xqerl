    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'environment-variable-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "environment-variable-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
