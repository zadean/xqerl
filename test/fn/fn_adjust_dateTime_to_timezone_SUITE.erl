    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1996-04-06T15:40:52-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2030-12-31T13:59:59-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2002-03-07T10:00:00-05:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2002-03-07T12:00:00-05:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2002-03-07T10:00:00-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-4.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2002-03-07T07:00:00-10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-5.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2002-03-08T03:00:00+10:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-6.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2002-03-06T15:00:00-08:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-7.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2002-03-07T10:00:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-8.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-9.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-10.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-11.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-12.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-13.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-14.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-15.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-16.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-17.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-18.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "-P1461DT1H") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-19.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "P364DT23H") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-adjust-dateTime-to-timezone-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-20.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-21.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-22.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-23.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-adjust-dateTime-to-timezone-24'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:adjust-dateTime-to-timezone(current-dateTime()[. lt xs:dateTime('2000-01-01T12:00:00Z')])",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-adjust-dateTime-to-timezone-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-AdjDateTimeToTimezoneFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-4.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-5.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-6.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-7.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-8.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-9.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-10.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-11.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-12.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-13.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-14.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-15.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-AdjDateTimeToTimezoneFunc-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-AdjDateTimeToTimezoneFunc-16.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K2-AdjDateTimeToTimezoneFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-AdjDateTimeToTimezoneFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "2000-01-01T00:00:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-adjust-dateTime-to-timezone-001'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "adjust-dateTime-to-timezone(current-dateTime(), implicit-timezone()) eq current-dateTime()",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-adjust-dateTime-to-timezone-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-adjust-dateTime-to-timezone-002'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "adjust-dateTime-to-timezone(xs:dateTime(\"-25252734927766555-06-07T01:00:00+02:00\"), xs:dayTimeDuration(\"PT0S\"))",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-adjust-dateTime-to-timezone-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-adjust-dateTime-to-timezone-003'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "adjust-dateTime-to-timezone(xs:dateTime(\"25252734927766555-07-28T23:00:00-02:00\"), xs:dayTimeDuration(\"PT0S\"))",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-adjust-dateTime-to-timezone-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-adjust-dateTime-to-timezone-004'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "adjust-dateTime-to-timezone(current-dateTime(), xs:dayTimeDuration(\"PT2H\")) eq adjust-dateTime-to-timezone(current-dateTime(), xs:dayTimeDuration(\"-PT2H\"))",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-adjust-dateTime-to-timezone-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
