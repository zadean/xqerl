    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "AAAAA") of
...
'fn-substring-before-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-23.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-substring-before-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-24.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-substring-before-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"𐀁\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-before-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-26.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-substring-before-27'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"banana\", \"ana\", \"http://www.w3.org/2013/collation/UCA?lang=en\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-28'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"banana\", \"ananas\", \"http://www.w3.org/2013/collation/UCA?lang=en\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-29'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"database\", \"BASE\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=primary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"data\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-before-30'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"database\", \"tabaS\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=primary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"da\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-before-32'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"dâtabase\", \"âtabase\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=primary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"d\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-before-34'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"database\", \"BASE\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-35'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"database\", \"tabaS\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-36'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"database\", \"bâs\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-37'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"dâtabase\", \"Base\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"dâta\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-before-38'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"database\", \"BASE\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=tertiary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-39'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"dataBase\", \"taBas\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=tertiary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-40'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"database\", \"bâse\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=tertiary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-before-43'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-before(\"Chapter-100\", \"Chapter-10\", \"http://www.w3.org/2013/collation/UCA?lang=en;numeric=yes\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-before-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringBeforeFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringBeforeFunc-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-substring-before-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-substring-before-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
