...
'fn-normalize-unicode1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "Nothing to normalize.") of
...
'fn-normalize-unicode1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode1args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode1args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode1args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode1args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode1args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode1args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "ÅÅ") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-normalize-unicode-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_error(Res, "FOCH0003") of
            true -> {comment, "Correct error"};
...
'fn-normalize-unicode-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "NORMALIZEDSTRING") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-normalize-unicode-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-normalize-unicode-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "NORMALIZEDSTRINGanother string") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-normalize-unicode-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "ALIZEDSTRING") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-normalize-unicode-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "64976") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-normalize-unicode-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "234, 64976, 234, 64976, 234") of
...
'fn-normalize-unicode-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-normalize-unicode-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "101, 64976, 770") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
...
'K-NormalizeUnicodeFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NormalizeUnicodeFunc-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NormalizeUnicodeFunc-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-fn-normalize-unicode-001a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-fn-normalize-unicode-001a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-fn-normalize-unicode-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-fn-normalize-unicode-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-fn-normalize-unicode-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-fn-normalize-unicode-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-fn-normalize-unicode-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-fn-normalize-unicode-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-fn-normalize-unicode-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-fn-normalize-unicode-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-fn-normalize-unicode-006a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-fn-normalize-unicode-006a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
