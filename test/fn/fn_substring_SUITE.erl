...
'fn-substring-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "ada") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "234") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-13.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-14.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-15.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "substring") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-17.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-18.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-19.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-20.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-21.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "BCDE") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-22.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'fn-substring-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-23.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"efgh\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-24.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"𐀁e\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-25.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-26.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-27.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-28.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-29.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-substring-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-30.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"𐀁𐀁\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-substring-31.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-SubstringFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-SubstringFunc-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringFunc-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringFunc-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringFunc-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringFunc-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringFunc-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringFunc-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringFunc-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringFunc-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringFunc-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringFunc-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-substring-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-substring-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-substring-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-substring-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
