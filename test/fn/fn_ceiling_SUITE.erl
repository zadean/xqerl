    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingint1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingint1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingint1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingint1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingint1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingintg1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingintg1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingintg1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingintg1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingintg1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingintg1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingdec1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingdec1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingdec1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingdec1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingdec1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingdec1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingdbl1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingdbl1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingdbl1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingdbl1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingdbl1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingdbl1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingflt1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingflt1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingflt1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingflt1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingflt1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingflt1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilinglng1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilinglng1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilinglng1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilinglng1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilinglng1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilinglng1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingusht1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingusht1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingusht1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingusht1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingusht1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingusht1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnint1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnint1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnint1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnint1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnint1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnint1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingpint1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingpint1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingpint1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingpint1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingpint1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingpint1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingulng1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingulng1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingulng1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingulng1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingulng1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingulng1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnpi1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnpi1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnpi1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnpi1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnpi1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnpi1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnni1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnni1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnni1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnni1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingnni1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingnni1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingsht1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingsht1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingsht1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingsht1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-ceilingsht1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceilingsht1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'K-CeilingFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-CeilingFunc-1.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K-CeilingFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-CeilingFunc-2.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K-CeilingFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-CeilingFunc-3.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K-CeilingFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-CeilingFunc-4.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K-CeilingFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-CeilingFunc-5.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K-CeilingFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-CeilingFunc-6.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-1.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-2.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-3.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-4.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-5.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-6.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-7.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-8.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-9.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-10.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-11.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'K2-CeilingFunc-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-CeilingFunc-12.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'fn-ceiling-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "fn-ceiling-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'fn-ceiling-decimal-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-decimal-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-decimal-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-decimal-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-decimal-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-decimal-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-decimal-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-decimal-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-decimal-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-decimal-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-decimal-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-decimal-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-decimal-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-decimal-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-double-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-double-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-ceiling-float-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-ceiling-float-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
