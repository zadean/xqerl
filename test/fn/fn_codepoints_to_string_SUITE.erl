...
'fn-codepoints-to-string1args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string1args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "bßڒき豈") of
...
'fn-codepoints-to-string1args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string1args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string1args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string1args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string1args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string1args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "codepoints-to-string") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-codepoints-to-string-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1a1a") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-codepoints-to-string-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-codepoints-to-string-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-codepoints-to-string-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1aab") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'K-CodepointToStringFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-CodepointToStringFunc-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-CodepointToStringFunc-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-013.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-014.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-015.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-016.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-017.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-018.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-019.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "11 11 11 11 11 11 11 11 11 11 11") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-codepoints-to-string-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-020.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-021'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-021.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-022.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-023'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-023.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-024.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-025'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-025.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-026'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-026.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-codepoints-to-string-027'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-codepoints-to-string-027.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
