    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "CCCCC") of
...
'fn-substring-after-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "substring-after") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-after-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"nana\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-after-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-23.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-substring-after-24'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "substring-after(\"banana\", \"A\", \"http://www.w3.org/2010/09/qt-fots-catalog/collation/caseblind\")",
    {Env, Opts} = xqerl_test:handle_environment([
        {'decimal-formats', []},
        {sources, []},
        {collections, []},
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-24.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-substring-after-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"𐀃\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-after-26'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "substring-after(\"banana\", \"A\", \"http://www.w3.org/2005/xpath-functions/collation/html-ascii-case-insensitive\")",
    {Env, Opts} = xqerl_test:handle_environment([
        {'decimal-formats', []},
        {sources, []},
        {collections, []},
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-26.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'fn-substring-after-27'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"banana\", \"ana\", \"http://www.w3.org/2013/collation/UCA?lang=en\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"na\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-after-28'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"banana\", \"ananas\", \"http://www.w3.org/2013/collation/UCA?lang=en\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-29'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"database\", \"DATA\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=primary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"base\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-after-30'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"database\", \"tabaS\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=primary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-32'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"dâtabase\", \"dâtab\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=primary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"ase\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-after-34'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"database\", \"DATA\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-35'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"database\", \"tabaS\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-36'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"database\", \"bâs\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-37'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"dâtabase\", \"â\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=secondary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "\"tabase\"") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'fn-substring-after-38'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"database\", \"DATA\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=tertiary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-39'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"dataBase\", \"taBas\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=tertiary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-40'(Config) ->
    __BaseDir = ?config(base_dir, Config),
    Qry =
        "fn:substring-after(\"dâtabase\", \"data\", \"http://www.w3.org/2013/collation/UCA?lang=en;strength=tertiary\")",
    Qry1 = Qry,
    io:format("Qry1: ~p~n", [Qry1]),
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-substring-after-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-substring-after-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-SubstringAfterFunc-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-SubstringAfterFunc-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-substring-after-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-substring-after-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
