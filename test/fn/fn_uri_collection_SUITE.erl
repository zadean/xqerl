    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-uri-collection-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-uri-collection-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-uri-collection-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'fn-uri-collection-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "fn-uri-collection-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-SeqUriCollectionFunc-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-SeqUriCollectionFunc-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-SeqUriCollectionFunc-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-SeqUriCollectionFunc-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'uri-collection-901'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "uri-collection-901.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'uri-collection-903'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "uri-collection-903.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
