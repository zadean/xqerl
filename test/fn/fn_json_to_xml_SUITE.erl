...
'json-to-xml-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-001.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-002.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-003.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
                ...
                [
                    ...
                    case
                        xqerl_test:assert_type(
                            Res,
                            "document-node(element(Q{http://www.w3.org/2005/xpath-functions}array))"
                        )
                    of
                        true -> {comment, "Correct type"};
                        {false, F} -> F
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/*/*[1] instance of element(Q{http://www.w3.org/2005/xpath-functions}number,xs:untyped)"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'json-to-xml-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-004.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/*/*[1] instance of element(Q{http://www.w3.org/2005/xpath-functions}string,xs:untyped)"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'json-to-xml-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-005.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/*/*[1] instance of element(Q{http://www.w3.org/2005/xpath-functions}boolean,xs:untyped)"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'json-to-xml-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-006.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert_xml(
                            Res,
                            "<array xmlns=\"http://www.w3.org/2005/xpath-functions\"><boolean>false</boolean></array>"
                        )
                    of
                        true -> {comment, "XML Deep equal"};
                        {false, F} -> F
...
'json-to-xml-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-007.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/*/*[1] instance of element(Q{http://www.w3.org/2005/xpath-functions}null,xs:untyped)"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'json-to-xml-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-008.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert_type(
                            Res,
                            "document-node(element(Q{http://www.w3.org/2005/xpath-functions}map))"
                        )
                    of
                        true -> {comment, "Correct type"};
                        {false, F} -> F
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/Q{http://www.w3.org/2005/xpath-functions}map/Q{http://www.w3.org/2005/xpath-functions}map[@key='glossary']/Q{http://www.w3.org/2005/xpath-functions}string[@key='title']"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/Q{http://www.w3.org/2005/xpath-functions}map/Q{http://www.w3.org/2005/xpath-functions}map[@key='glossary']/Q{http://www.w3.org/2005/xpath-functions}map[@key='GlossDiv']"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'json-to-xml-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-009.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/Q{http://www.w3.org/2005/xpath-functions}map/Q{http://www.w3.org/2005/xpath-functions}map[@key='menu']/Q{http://www.w3.org/2005/xpath-functions}string[@key='header'][.='SVG Viewer']"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "$result/Q{http://www.w3.org/2005/xpath-functions}map/Q{http://www.w3.org/2005/xpath-functions}map[@key='menu']/Q{http://www.w3.org/2005/xpath-functions}array[@key='items']/Q{http://www.w3.org/2005/xpath-functions}map[not(@*)]/Q{http://www.w3.org/2005/xpath-functions}string[@key='id'][.='Open']"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'json-to-xml-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-010.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<map xmlns=\"http://www.w3.org/2005/xpath-functions\"><string key=\"key\">Data with \" within it</string></map>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-011.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<string xmlns=\"http://www.w3.org/2005/xpath-functions\" key=\"key\">Data with \" within it</string>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-012.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    case
                        xqerl_test:assert_type(
                            Res,
                            "element(Q{http://www.w3.org/2005/xpath-functions}string)"
                        )
                    of
                        true -> {comment, "Correct type"};
                        {false, F} -> F
                    ...
                    case
                        xqerl_test:assert(Res, "$result/self::*:string eq 'Data with \" within it'")
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
                    end,
                    ...
                    case
                        xqerl_test:assert(
                            Res,
                            "namespace-uri($result/self::*:string) eq 'http://www.w3.org/2005/xpath-functions'"
                        )
                    of
                        true -> {comment, "Correct results"};
                        {false, F} -> F
...
'json-to-xml-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-013.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
            ...
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert_xml(
                            Res,
                            "<string xmlns=\"http://www.w3.org/2005/xpath-functions\">Data with \" within it</string>"
                        )
                    of
                        true -> {comment, "XML Deep equal"};
                        {false, F} -> F
...
'json-to-xml-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-014.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
                ...
                [
                    ...
                    case
                        xqerl_test:assert_xml(
                            Res,
                            "<string\n"
                            "                 xmlns=\"http://www.w3.org/2005/xpath-functions\" key=\"Key &#34; with quote\">Data with \" within it</string>"
                        )
                    of
                        true -> {comment, "XML Deep equal"};
                        {false, F} -> F
...
'json-to-xml-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-015.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-018.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-019.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-020.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-021'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-021.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-022.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-023'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-023.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-024.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                ...
                "         ><j:string escaped=\"true\" key=\"a\">\\uDA00</j:string><j:string escaped-key=\"true\" key=\"\\uDD00\">bell</j:string></j:map>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-025'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-025.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-026'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-026.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-027'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-027.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-028'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-028.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-029'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-029.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<number \n"
                "         xmlns=\"http://www.w3.org/2005/xpath-functions\">23</number>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-030'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-030.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<number \n"
                "         xmlns=\"http://www.w3.org/2005/xpath-functions\">23E0</number>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-031'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-031.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<number \n"
                "         xmlns=\"http://www.w3.org/2005/xpath-functions\">0.23e+02</number>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-032'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-032.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<number \n"
                "         xmlns=\"http://www.w3.org/2005/xpath-functions\">0</number>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-033'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-033.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-034'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-034.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<map \n"
                "         xmlns=\"http://www.w3.org/2005/xpath-functions\"><string key=\"\"/><string key=\"0\">0</string></map>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
...
'json-to-xml-035'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-035.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-036'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-036.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-039'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-039.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-040'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-040.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-041'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-041.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-042'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-042.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'json-to-xml-043'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-043.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-048'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-048.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'json-to-xml-049'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "json-to-xml-049.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case
            xqerl_test:assert_xml(
                Res,
                "<string xmlns=\"http://www.w3.org/2005/xpath-functions\" escaped=\"true\">\\\\/\"\\r\\t </string>"
            )
        of
            true -> {comment, "XML Deep equal"};
            {false, F} -> F
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-002.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-003.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-004.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-005.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-006.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-007.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-008.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-009.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-010.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-011.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-012.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-013.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-014.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-015.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-016.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-017.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-018.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-019.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-020.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-021'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-021.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-022.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-023'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-023.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-024.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-025'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-025.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-026'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-026.xq"),
                Qry1
            ),
            xqerl:run(Mod, Opts)
        of
...
'json-to-xml-error-029'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-029.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-030'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-030.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-031'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-031.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-032'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-032.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-033'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-033.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-034'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-034.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-035'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-035.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-037'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-037.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-038'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-038.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-039'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-039.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-040'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-040.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'json-to-xml-error-041'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "json-to-xml-error-041.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
