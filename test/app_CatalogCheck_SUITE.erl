...
environment('catalog') ->
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xqerl/test/QT3-test-suite/catalog.xml",".",""}]},
{schemas, [{"C:/git/zadean/xqerl/test/QT3-test-suite/catalog-schema.xsd","http://www.w3.org/2010/09/qt-fots-catalog"}]},
{collections, []},
