...
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/prod/ContextItemDecl/libmodule-2.xq") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/prod/ContextItemDecl/libmodule-1.xq") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/prod/ContextItemDecl/libmodule-3.xq") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/prod/ContextItemDecl/libmodule-4.xq") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/prod/ContextItemDecl/libmodule-5.xq") catch _:_ -> ok end,Config.
all() -> [
   'contextDecl-014',
   'contextDecl-015',
   'contextDecl-016',
...
{namespaces, []},
{resources, []},
{modules, [{"C:/git/zadean/xqerl/test/QT3-test-suite/prod/ContextItemDecl/libmodule-2.xq","http://www.w3.org/TestModules/libmodule2"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
   Res = try xqerl:run(Qry1,Opts) of D -> D catch _:E -> E end,
...
{namespaces, []},
{resources, []},
{modules, [{"C:/git/zadean/xqerl/test/QT3-test-suite/prod/ContextItemDecl/libmodule-5.xq","http://www.w3.org/TestModules/libmodule5"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
   Res = try xqerl:run(Qry1,Opts) of D -> D catch _:E -> E end,
