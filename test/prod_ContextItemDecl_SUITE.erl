...
, try  xqerl:compile("C:/git/xqerl/test/QT3_1_0/prod/ContextItemDecl/libmodule-2.xq") catch _:_ -> ok end
, try  xqerl:compile("C:/git/xqerl/test/QT3_1_0/prod/ContextItemDecl/libmodule-1.xq") catch _:_ -> ok end
, try  xqerl:compile("C:/git/xqerl/test/QT3_1_0/prod/ContextItemDecl/libmodule-3.xq") catch _:_ -> ok end,Config.
all() -> [
   'contextDecl-014',
   'contextDecl-015',
   'contextDecl-016',
...
{namespaces, []},
{resources, []},
{modules, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/ContextItemDecl/libmodule-2.xq","http://www.w3.org/TestModules/libmodule2"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   Res = xqerl:run(Qry1),
   ResXml = xqerl_node:to_xml(Res),
