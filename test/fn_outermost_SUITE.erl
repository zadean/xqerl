...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "innermost/innermost.xml"), ".",""},
{"file://"++filename:join(BaseDir, "innermost/doc1.xml"), "$doc1",""},
{"file://"++filename:join(BaseDir, "innermost/doc2.xml"), "$doc2",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
