...
",
   ...
   Exp = "
         <result/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<result/>"++"</x>)")) == "true" of
...
",
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<fs:FileName xmlns:fs=\"http://www.example.com/filesystem\">File00000000000</fs:FileName>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
",
   ...
   Exp = "
         <south mark=\"s0\" />
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<south mark=\"s0\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
let $i := <e>
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<!--content--><!--content--><!--content-->"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
let $i := <e>
   ...
   Exp = "
         <!--content-->
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<!--content-->"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
