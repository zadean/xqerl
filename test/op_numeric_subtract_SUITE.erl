...
'op-numeric-subtract-big-01'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_types:string_value(Res) == "-79228162514264337593543950336") orelse (is_tuple(Res) andalso element(1,Res) == 'xqError' andalso element(4,element(2,Res)) == "FOAR0002") of true -> {comment, "any-of"};
   Q -> ct:fail(['any-of', {Res,Exp,Q}]) end.
