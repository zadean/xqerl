    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-normalizedstring-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-normalizedstring-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-normalizedstring-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-normalizedstring-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-normalizedstring-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-normalizedstring-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-normalizedstring-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-normalizedstring-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-normalizedstring-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-normalizedstring-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-normalizedstring-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
