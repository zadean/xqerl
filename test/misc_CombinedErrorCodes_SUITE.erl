...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "../prod/OrderByClause/orderData.xml"), ".",""}]},
...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "CombinedErrorCodes/namespace-sensitive.xml"), ".",""}]},
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/moduleDefs-lib.xq"),"http://www.w3.org/TestModules/defs"},
{filename:join(BaseDir, "CombinedErrorCodes/test1-lib.xq"),"http://www.w3.org/TestModules/test1"}]}
]),
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/XQST0046_lib.xq"),"http://www.example.org/test"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/XQST0047_lib.xq"),"http://www.example.org/foo"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/XQST0048_lib.xq"),"http://www.example.org/foo"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/XQST0059_lib.xq"),"http://www.example.org"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/XQST0070_lib.xq"),"http://www.example.org/foo"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/XQST0088_lib.xq"),"http://www.example.org/test"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
...
{namespaces, []},
{resources, []},
{modules, [{filename:join(BaseDir, "CombinedErrorCodes/XQST0093_lib1.xq"),"http://www.example.org/foo"},
{filename:join(BaseDir, "CombinedErrorCodes/XQST0093_lib2.xq"),"http://www.example.org/foo"}]}
]),
   Qry1 = lists:flatten(Env ++ Qry),
   io:format("Qry1: ~p~n",[Qry1]),
