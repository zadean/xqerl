...
[{sources, []},
{schemas, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/SchemaImport/unionListDefined.xsd","http://www.w3.org/XQueryTest/unionListDefined"}]},
{collections, []},
{'static-base-uri', []},
{params, []},
{namespaces, []},
...
environment('derived') ->
[{sources, []},
{schemas, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/CastExpr/derived.xsd","http://www.w3.org/XQueryTest/derivedTypes"}]},
{collections, []},
{'static-base-uri', []},
{params, []},
{namespaces, []},
...
'K-SeqExprCastable-4a'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (is_tuple(Res) andalso element(1,Res) == 'xqError' andalso element(4,element(2,Res)) == "XPST0003") orelse (is_tuple(Res) andalso element(1,Res) == 'xqError' andalso element(4,element(2,Res)) == "XQST0052") of true -> {comment, "any-of"};
