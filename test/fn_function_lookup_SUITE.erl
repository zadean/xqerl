...
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/context-item-module.xqm") catch _:_ -> ok end,Config.
all() -> [
...
{"C:/git/zadean/xqerl/test/QT3-test-suite/fn/json-to-xml/data001.json","http://www.w3.org/qt3/json/data001-json"}]},
{modules, []}
].
