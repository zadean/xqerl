...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/fn/function-lookup/function-lookup.xml",".","http://www.w3.org/fots/fn/function-lookup/function-lookup.xml"}]},
{schemas, []},
{collections, [{"",["file:///C:/git/xqerl/test/QT3_1_0/fn/function-lookup/collection-1.xml",
"file:///C:/git/xqerl/test/QT3_1_0/fn/function-lookup/collection-2.xml"]}]},
{'static-base-uri', []},
{params, []},
{namespaces, []},
...
'fn-function-lookup-614'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_types:string_value(Res) == "not-available") orelse (xqerl_types:string_value(Res) == "Feb") of true -> {comment, "any-of"};
...
'fn-function-lookup-615'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_types:string_value(Res) == "not-available") orelse (xqerl_types:string_value(Res) == "29") of true -> {comment, "any-of"};
   Q -> ct:fail(['any-of', {Res,Exp,Q}]) end.
