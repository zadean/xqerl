...
, try  xqerl:compile("C:/git/zadean/xquery-3.1/QT3-test-suite/prod/DecimalFormatDecl/dfd-module-001.xq") catch _:_ -> ok end,Config.
all() -> [
   'decimal-format-01',
   'decimal-format-02',
   'decimal-format-03',
...
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/prod/DecimalFormatDecl.xml"}]},
{vars, []},
{params, []},
{namespaces, []},
{resources, []},
