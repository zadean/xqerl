    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-01.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-02'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-02.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"^map\\{\\}$"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-03'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-03.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-04'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-04.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"^5$"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-05'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-05.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"^\"simple string\"$"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-06'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-06.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(Res, <<"^<test>content</test>$"/utf8>>, <<"">>)
        of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
...
'Serialization-adaptive-07'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-07.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-08'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-08.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"^content$"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-09'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-09.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"^<!--comment-->$"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"^fn:exists#1$"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"1\\r?\\n2\\r?\\n3"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"1-2-3"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^\\[[(]?<element>content</element>[)]?,[(]?att-name=\"att-value\"[)]?\\]$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^map\\{\"key\":att-name=\"att-value\"\\}$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"map\\{\"infinity\":xs:float\\(\"INF\"\\)\\}"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^\\[fn:exists#1,\\(anonymous-function\\)#1\\]$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^\\[[(]?fn:exists#1[)]?,[(]?1[)]?,[(]?<element>content</element>[)]?,\\(\\),[(]?\\(anonymous-function\\)#1[)]?,[(]?map\\{\"infinity\":INF[)]?\\},[(]?\"json-string\"[)]?\\]$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            lists:all(
                ...
                [
                    case
                        xqerl_test:assert_serialization_match(Res, <<"\"2015\":1"/utf8>>, <<"">>)
                    of
                        true -> {comment, "Correct serialization"};
                        {false, F} -> F
                    end,
...
'Serialization-adaptive-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"\"untypedAtomic\""/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^xs:dateTime\\(\"1999-05-31T13:20:00-05:00\"\\)$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^xs:duration\\(\"P1Y2M3DT10H30M23S\"\\)$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"^xs:float\\(\"1\"\\)$"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"1\\.0e0"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"1.2"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_serialization_match(Res, <<"1"/utf8>>, <<"">>) of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
    case Out of
...
'Serialization-adaptive-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-53'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-53.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-54'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-54.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-55'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-55.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-56'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-56.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-57.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-58'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-58.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-59.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-60'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-60.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(Res, <<"^xs:gYear\\(\"2000\"\\)"/utf8>>, <<"">>)
        of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
...
'Serialization-adaptive-61'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-61.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-62'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-62.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(Res, <<"^xs:gDay\\(\"---01\"\\)"/utf8>>, <<"">>)
        of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
...
'Serialization-adaptive-63'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-63.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(Res, <<"^xs:gMonth\\(\"--01\"\\)"/utf8>>, <<"">>)
        of
            true -> {comment, "Correct serialization"};
            {false, F} -> F
        end,
...
'Serialization-adaptive-64'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-64.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-65'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-65.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-66'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-66.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-67'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-67.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-68'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-68.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-69'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-69.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-70'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-70.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-71'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-71.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-72'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-72.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-73'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-73.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-74'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-74.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-75'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-75.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-76'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-76.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^xs:hexBinary\\(\"D74D35D35D35\"\\)$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-77'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-77.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-78'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-78.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"^Q\\{http://www.w3.org/2001/XMLSchema\\}integer$"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-adaptive-79'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-79.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-80'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-80.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-81'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-81.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-82'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-82.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-83'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-83.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-adaptive-84'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-adaptive-84.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
