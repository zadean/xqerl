    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-1a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-1a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"<html><body><area></area><base></base><br></br><col></col><embed></embed><frame></frame><hr></hr><img></img><input></input><isindex></isindex><link></link><meta></meta><param></param></body></html>"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-xhtml-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
            ...
            lists:all(
                ...
                [
                    case
                        xqerl_test:assert_serialization_match(
                            Res,
                            <<"<html><body><area\\s*/><base\\s*/><br\\s*/><col\\s*/><embed\\s*/><hr\\s*/><img\\s*/><input\\s*/><keygen\\s*/><link\\s*/><meta\\s*/><param\\s*/><source\\s*/><track\\s*/><wbr\\s*/></body></html>"/utf8>>,
                            <<"">>
                        )
                    of
                        true -> {comment, "Correct serialization"};
...
'Serialization-xhtml-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
            ...
            lists:all(
                ...
                [
                    case
                        xqerl_test:assert_serialization_match(
                            Res,
                            <<"<html xmlns=\"http://www.w3.org/1999/xhtml\"><body><area\\s*/><base\\s*/><br\\s*/><col\\s*/><embed\\s*/><frame></frame><hr\\s*/><img\\s*/><input\\s*/><isindex></isindex><link\\s*/><meta\\s*/><param\\s*/></body></html>"/utf8>>,
                            <<"">>
                        )
                    of
                        true -> {comment, "Correct serialization"};
...
'Serialization-xhtml-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
        ...
        case
            lists:all(
                ...
                [
                    ...
                    case
                        xqerl_test:assert_serialization_match(Res, <<"isle2>NO</"/utf8>>, <<"">>)
                    of
                        true -> {comment, "Correct serialization"};
                        {false, F} -> F
                    end,
                    case
                        (case
                            xqerl_test:assert_serialization_match(Res, <<">YES<"/utf8>>, <<"">>)
                        of
                            true -> {comment, "Correct serialization"};
                            {false, F} -> F
                        end)
...
'Serialization-xhtml-19a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-19a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-19b'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-19b.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-19c'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-19c.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            (case xqerl_test:assert_serialization_match(Res, <<"DOCTYPE"/utf8>>, <<"">>) of
                true -> {comment, "Correct serialization"};
                {false, F} -> F
            end)
        of
...
'Serialization-xhtml-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
        ...
        case
            lists:all(
                ...
                [
                    ...
                    case
                        (case
                            xqerl_test:assert_serialization_match(Res, <<"PUBLIC"/utf8>>, <<"s">>)
                        of
                            true -> {comment, "Correct serialization"};
                            {false, F} -> F
                        end)
...
'Serialization-xhtml-27a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-27a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            lists:all(
                ...
                [
                    case
                        xqerl_test:assert_serialization_match(Res, <<"<head><meta "/utf8>>, <<"i">>)
                    of
                        true -> {comment, "Correct serialization"};
                        {false, F} -> F
                    end,
                    ...
                    case
                        xqerl_test:assert_serialization_match(
                            Res,
                            <<"content=['\"]text/html; *charset=UTF-8['\"]"/utf8>>,
                            <<"i">>
                        )
                    of
                        true -> {comment, "Correct serialization"};
...
'Serialization-xhtml-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-36a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-36a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-37a'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-37a.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"<html xmlns=\"http://www.w3.org/1999/xhtml\"><head><meta.*?/><title>Test doc</title></head><body><h1>Header</h1><p>Content</p></body></html>"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-xhtml-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"<svg xmlns=\"http://www.w3.org/2000/svg\"><rectangle></rectangle></svg>"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-xhtml-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case
            xqerl_test:assert_serialization_match(
                Res,
                <<"<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mrow><msup><mi> a </mi>"/utf8>>,
                <<"">>
            )
        of
            true -> {comment, "Correct serialization"};
...
'Serialization-xhtml-57'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-57.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-58'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-58.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-59'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-59.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-60'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-60.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-61'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-61.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-62'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-62.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-63'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-63.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-64'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-64.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-65'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-65.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-66'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-66.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'Serialization-xhtml-67'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "Serialization-xhtml-67.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
