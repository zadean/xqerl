...
{schemas, []},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xquery-3.1/QT3-test-suite/map/find.xml"}]},
{params, []},
{vars, []},
{namespaces, [{"http://www.w3.org/2005/xpath-functions/map","map"}]},
{resources, [{"C:/git/zadean/xquery-3.1/QT3-test-suite/fn/parse-json/data004.json","http://www.w3.org/qt3/json/data004-json"}]},
{modules, []}
].
