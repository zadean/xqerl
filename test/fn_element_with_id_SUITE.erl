...
environment('id-idref2') ->
[{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/id/id2.xml",".",""}]},
{schemas, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/id/id.xsd","http://www.w3.org/XQueryTest/ididrefs"}]},
{collections, []},
{'static-base-uri', [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/element-with-id.xml"}]},
{params, []},
{namespaces, [{"http://www.w3.org/XQueryTest/ididrefs","ids"}]},
{resources, []},
{modules, []}
].
'fn-element-with-id-1'(_Config) ->
   {skip,"Validation Environment"}.
'fn-element-with-id-2'(_Config) ->
   {skip,"Validation Environment"}.
'fn-element-with-id-3'(_Config) ->
   {skip,"Validation Environment"}.
'fn-element-with-id-4'(_Config) ->
   {skip,"Validation Environment"}.
'fn-element-with-id-5'(_Config) ->
   {skip,"Validation Environment"}.
