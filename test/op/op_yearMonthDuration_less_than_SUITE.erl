    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2argsNew-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2argsNew-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-thanNew-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-thanNew-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-less-than-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-less-than-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationLT-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationLT-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationLT-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationLT-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationLT-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationLT-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationLT-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationLT-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationLT-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationLT-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationLT-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationLT-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-less-than-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-less-than-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-less-than-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-less-than-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-less-than-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-less-than-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-less-than-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-less-than-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-less-than-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-less-than-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-less-than-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-less-than-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
