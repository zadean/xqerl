    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(
                    __BaseDir,
                    "op-divide-yearMonthDuration-by-yearMonthDuration2args-1.xq"
                ),
                Qry1
            ),
            xqerl:run(Mod)
...
'op-divide-yearMonthDuration-by-yearMonthDuration2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(
                    __BaseDir,
                    "op-divide-yearMonthDuration-by-yearMonthDuration2args-2.xq"
                ),
                Qry1
            ),
            xqerl:run(Mod)
    ...
    Out =
        case xqerl_test:assert_eq(Res, "12006") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-divide-yearMonthDuration-by-yearMonthDuration2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(
                    __BaseDir,
                    "op-divide-yearMonthDuration-by-yearMonthDuration2args-3.xq"
                ),
                Qry1
            ),
            xqerl:run(Mod)
    ...
    Out =
        case xqerl_test:assert_eq(Res, "24372") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(
                    __BaseDir,
                    "op-divide-yearMonthDuration-by-yearMonthDuration2args-4.xq"
                ),
                Qry1
            ),
            xqerl:run(Mod)
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(
                    __BaseDir,
                    "op-divide-yearMonthDuration-by-yearMonthDuration2args-5.xq"
                ),
                Qry1
            ),
            xqerl:run(Mod)
...
'op-divide-yearMonthDuration-by-yMD-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "-2.5") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-divide-yearMonthDuration-by-yMD-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "1.859410358565737") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-divide-yearMonthDuration-by-yMD-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-yearMonthDuration-by-yMD-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-yearMonthDuration-by-yMD-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationDivideYMD-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationDivideYMD-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(
                    __BaseDir,
                    "cbcl-divide-yearMonthDuration-by-yearMonthDuration-001.xq"
                ),
                Qry1
            ),
            xqerl:run(Mod)
