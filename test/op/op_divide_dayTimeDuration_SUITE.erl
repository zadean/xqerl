    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "P1DT14H4M") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'op-divide-dayTimeDuration-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "-P5DT30M30S") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'op-divide-dayTimeDuration-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-divide-dayTimeDuration-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-divide-dayTimeDuration-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationDivide-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationDivide-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-divide-dayTimeDuration-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-divide-dayTimeDuration-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-divide-dayTimeDuration-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-divide-dayTimeDuration-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-divide-dayTimeDuration-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-divide-dayTimeDuration-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-div-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-001.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-002.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-003.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "24") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-div-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-004.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-005.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-006.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-007.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-008.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-009.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-010.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-011.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-012.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-013.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-014.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-div-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-015.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "PT12H") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'cbcl-div-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "cbcl-div-016.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
