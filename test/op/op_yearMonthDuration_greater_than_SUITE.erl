    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-yearMonthDuration-greater-than-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-yearMonthDuration-greater-than-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationGT-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationGT-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationGT-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationGT-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationGT-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationGT-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationGT-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationGT-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationGT-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationGT-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-YearMonthDurationGT-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-YearMonthDurationGT-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-greater-than-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-greater-than-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-greater-than-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-greater-than-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-greater-than-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-greater-than-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-greater-than-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-greater-than-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-greater-than-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-greater-than-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-yearMonthDuration-greater-than-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-yearMonthDuration-greater-than-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
