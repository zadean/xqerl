    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalint2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalint2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalintg2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalintg2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldec2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldec2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equaldbl2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equaldbl2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalflt2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalflt2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equallng2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equallng2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalusht2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalusht2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnint2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnint2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalpint2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalpint2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalulng2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalulng2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnpi2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnpi2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalnni2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalnni2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equalsht2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equalsht2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-equal-emptyseq'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-equal-emptyseq.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericEqual-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-13.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-14.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-15.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-17.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-18.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-19.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-20.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-21.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-22.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-23.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-24.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-25.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-26.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-27.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-28.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-29.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-30.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-31.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-32.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-33.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-34.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-35.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-36.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-37.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-38.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-39.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-40.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-41.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-42.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-43.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-44.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-45.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-46.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericEqual-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericEqual-47.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericEqual-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericEqual-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericEqual-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericEqual-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericEqual-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericEqual-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericEqual-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericEqual-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericEqual-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericEqual-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericEqual-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericEqual-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-numeric-equal-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-013.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-014.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-015.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-016.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-017.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-equal-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-equal-018.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
