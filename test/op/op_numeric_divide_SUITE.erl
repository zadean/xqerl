    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "0.8726093965") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-numeric-divideint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "-0.9999999995") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-numeric-divideint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "1.145988118") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-numeric-divideint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "-1.0000000005") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-numeric-divideintg2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideintg2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideintg2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideintg2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideintg2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideintg2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideintg2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideintg2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideintg2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideintg2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideintg2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideintg2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedec2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedec2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedec2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedec2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedec2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedec2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedec2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedec2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedec2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedec2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedbl2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedbl2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedbl2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedbl2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedbl2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedbl2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividedbl2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividedbl2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideflt2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideflt2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideflt2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideflt2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideflt2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideflt2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideflt2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideflt2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividelng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividelng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividelng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividelng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividelng2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividelng2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividelng2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividelng2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividelng2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividelng2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideusht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideusht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideusht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideusht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividepint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividepint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividepint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividepint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividepint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividepint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividepint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividepint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividepint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividepint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideulng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideulng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divideulng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divideulng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenpi2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenpi2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenpi2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenpi2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenpi2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenpi2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenpi2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenpi2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenni2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenni2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividenni2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividenni2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividesht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividesht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividesht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividesht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "0.16248") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-numeric-dividesht2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividesht2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividesht2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividesht2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_eq(Res, "6.15477") of
            true -> {comment, "Equal"};
            {false, F} -> F
        end,
    case Out of
...
'op-numeric-dividesht2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividesht2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert(Res, "abs($result + 1.000030518509475997) lt 1e-12") of
...
'op-numeric-dividemix2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-dividemix2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-dividemix2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericDivide-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericDivide-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericDivide-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericDivide-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericDivide-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericDivide-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divide-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divide-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-013.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-014.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-divide-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-divide-015.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-divide-big-01'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-divide-big-01.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
