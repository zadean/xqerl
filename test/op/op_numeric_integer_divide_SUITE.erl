    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideintg2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideintg2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideintg2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideintg2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideintg2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideintg2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideintg2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideintg2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideintg2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideintg2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedec2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedec2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedec2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedec2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedec2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedec2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedec2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedec2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedec2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedec2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividelng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividelng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividelng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividelng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividelng2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividelng2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividelng2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividelng2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividelng2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividelng2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideusht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideusht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideusht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideusht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividepint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividepint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividepint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividepint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividepint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividepint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividepint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividepint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividepint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividepint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideulng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideulng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divideulng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divideulng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenpi2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenpi2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenpi2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenpi2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenpi2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenpi2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenpi2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenpi2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenni2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenni2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividenni2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividenni2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividesht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividesht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividesht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividesht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividesht2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividesht2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividesht2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividesht2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividesht2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividesht2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividemix2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividemix2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-divide-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-divide-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-17.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-18.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-19.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-20.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-21.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-22.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-23.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-24'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-24.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-25'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-25.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-26'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-26.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-27'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-27.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-28'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-28.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-29'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-29.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-30'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-30.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-31'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-31.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-32'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-32.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-33'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-33.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-34'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-34.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-35'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-35.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-36'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-36.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-37'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-37.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-38'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-38.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-39'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-39.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-40'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-40.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-41'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-41.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-42'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-42.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-43'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-43.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-44'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-44.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-45'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-45.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-46'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-46.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-47'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-47.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-48'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-48.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-49'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-49.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-50'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-50.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-51'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-51.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-52'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-52.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericIntegerDivide-53'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-NumericIntegerDivide-53.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K2-NumericIntegerDivide-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K2-NumericIntegerDivide-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividefloat2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividefloat2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividefloat2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividefloat2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividefloat2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividefloat2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividefloat2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividefloat2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividefloat2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividefloat2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedouble2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedouble2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedouble2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedouble2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedouble2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedouble2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedouble2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedouble2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-integer-dividedouble2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-integer-dividedouble2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-idivide-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-idivide-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
                    ...
                    case
                        lists:all(
                            ...
                            [
                                ...
                                case
                                    xqerl_test:assert(Res, "string-length(string($result)) gt 299")
                                of
...
'cbcl-numeric-idivide-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-idivide-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-idivide-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-idivide-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-idivide-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-idivide-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
                        ...
                        lists:all(
                            ...
                            [
                                ...
                                case
                                    xqerl_test:assert(
                                        Res,
                                        "matches(string($result), '^[0-9]{75,76}$')"
                                    )
                                of
                                    true -> {comment, "Correct results"};
                                    {false, F} -> F
...
'cbcl-numeric-idivide-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-idivide-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
