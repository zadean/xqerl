    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "0969-07-01T00:00:00Z") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'op-subtract-yearMonthDuration-from-dateTime2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1999-08-30T11:12:00") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'op-subtract-yearMonthDuration-from-dateTime-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "1981-03-05T14:34:36Z") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'op-subtract-yearMonthDuration-from-dateTime-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_string_value(Res, "0021-08-01T01:01:01Z") of
            true -> {comment, "String correct"};
            {false, F} -> F
        end,
    case Out of
...
'op-subtract-yearMonthDuration-from-dateTime-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-15.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-subtract-yearMonthDuration-from-dateTime-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-subtract-yearMonthDuration-from-dateTime-16.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DateTimeSubtractYMD-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DateTimeSubtractYMD-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-subtract-yearMonthDuration-from-dateTime-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-subtract-yearMonthDuration-from-dateTime-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-subtract-yearMonthDuration-from-dateTime-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-subtract-yearMonthDuration-from-dateTime-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
