    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than2args-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than2args-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-7.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-8.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-9.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-10.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-11.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-12.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-13.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-dayTimeDuration-less-than-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-dayTimeDuration-less-than-14.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationLT-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationLT-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationLT-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationLT-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationLT-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationLT-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationLT-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationLT-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationLT-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationLT-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-DayTimeDurationLT-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "K-DayTimeDurationLT-6.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-dayTimeDuration-less-than-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-dayTimeDuration-less-than-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-dayTimeDuration-less-than-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-dayTimeDuration-less-than-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-dayTimeDuration-less-than-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-dayTimeDuration-less-than-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-dayTimeDuration-less-than-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-dayTimeDuration-less-than-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-dayTimeDuration-less-than-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-dayTimeDuration-less-than-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-dayTimeDuration-less-than-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-dayTimeDuration-less-than-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-value-less-equal-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-value-less-equal-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
