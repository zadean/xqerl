    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanintg2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanintg2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanintg2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanintg2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanintg2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanintg2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanintg2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanintg2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanintg2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanintg2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandec2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandec2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandec2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandec2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandec2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandec2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandec2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandec2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandec2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandec2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandbl2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandbl2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandbl2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandbl2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandbl2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandbl2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandbl2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandbl2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thandbl2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thandbl2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanflt2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanflt2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanflt2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanflt2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanflt2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanflt2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanflt2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanflt2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanflt2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanflt2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanlng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanlng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanlng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanlng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanlng2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanlng2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanlng2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanlng2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanlng2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanlng2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanusht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanusht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanusht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanusht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanusht2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanusht2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanusht2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanusht2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanusht2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanusht2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanpint2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanpint2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanpint2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanpint2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanpint2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanpint2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanpint2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanpint2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanpint2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanpint2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanulng2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanulng2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanulng2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanulng2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanulng2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanulng2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanulng2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanulng2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thanulng2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thanulng2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannpi2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannpi2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannpi2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannpi2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannpi2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannpi2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannpi2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannpi2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannpi2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannpi2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannni2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannni2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannni2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannni2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannni2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannni2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannni2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannni2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thannni2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thannni2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thansht2args-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thansht2args-1.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thansht2args-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thansht2args-2.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thansht2args-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thansht2args-3.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thansht2args-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thansht2args-4.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'op-numeric-greater-thansht2args-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "op-numeric-greater-thansht2args-5.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'K-NumericGT-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-5'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-5.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-6'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-6.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-7'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-7.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-8'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-8.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-9'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-9.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-10'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-10.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-11'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-11.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-12'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-12.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-13'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-13.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-14'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-14.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-15'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-15.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-16'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-16.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-17'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-17.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-18'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-18.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-19'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-19.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-20'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-20.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-21'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-21.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-22'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-22.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K-NumericGT-23'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K-NumericGT-23.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericGT-1'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericGT-1.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericGT-2'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericGT-2.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericGT-3'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericGT-3.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'K2-NumericGT-4'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "K2-NumericGT-4.xq"), Qry1),
            xqerl:run(Mod)
        of
            D -> D
        catch
...
'cbcl-numeric-greater-than-001'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-001.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-002'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-002.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-003'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-003.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-004'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-004.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-005'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-005.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-006'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-006.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-007'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-007.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-008'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-008.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-009'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-009.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-010'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-010.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-011'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-011.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-012'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-012.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-013'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-013.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-014'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-014.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-015'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-015.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-016'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-016.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-017'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-017.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-018'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-018.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-019'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-019.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-020'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-020.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-021'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-021.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-022'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-022.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-023'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-023.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'cbcl-numeric-greater-than-024'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "cbcl-numeric-greater-than-024.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
...
'numeric-greater-than-101'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "numeric-greater-than-101.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(2345.6, 5678, 12345, 56789, xs:double(\"INF\"))") of
...
'numeric-greater-than-102'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(
                filename:join(__BaseDir, "numeric-greater-than-102.xq"),
                Qry1
            ),
            xqerl:run(Mod)
        of
    ...
    Out =
        case xqerl_test:assert_deep_eq(Res, "(1234, 2345.6, 1555, 12345)") of
            true -> {comment, "Deep equal"};
            {false, F} -> F
        end,
    case Out of
