...
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/invalid-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/external-var-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/context-item-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/dynamic-error-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/valid-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/functions-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/functions2-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/external-vars-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-func-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-module.xqm") catch _:_ -> ok end
...
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-vars-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-vars2-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/external-vars2-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import2-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/middle-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-vars3-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-self-module.xqm") catch _:_ -> ok end
...
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/load-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/load-self-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/decimal-format-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/empty-least-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/empty-greatest-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/boundary-space1-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/boundary-space2-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-schema-hats-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-schema-abf-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/import-schema-abf2-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/context-item2-module.xqm") catch _:_ -> ok end
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/fn/load-xquery-module/main-module.xqm") catch _:_ -> ok end,Config.
all() -> [
...
[{'decimal-formats', []},
{sources, []},
{schemas, [{"C:/git/zadean/xqerl/test/QT3-test-suite/prod/SchemaImport/hats.xsd","http://www.w3.org/XQueryTest/hats"}]},
{collections, []},
...
[{'decimal-formats', []},
{sources, []},
{schemas, [{"C:/git/zadean/xqerl/test/QT3-test-suite/prod/SchemaImport/abf.xsd","http://www.w3.org/XQueryTest/abf"}]},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xqerl/test/QT3-test-suite/fn/"}]},
{params, []},
{vars, []},
