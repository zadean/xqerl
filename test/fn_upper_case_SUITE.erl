...
'fn-upper-case-19'(_Config) ->
   ...
   Out =    case xqerl_test:assert_deep_eq(Res,"
            ...
            1017, 1011, 1012, 917, 1014, 1015, 1015, 1017, 1018, 1018, 1020, 1021, 1022, 1023") of 
      true -> {comment, "Deep equal"};
      {false, F} -> F 
   end, 
   case Out of
