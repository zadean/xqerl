...
{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/filter/filter003.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
'filter-005'(_Config) ->
   ...
   Env = xqerl_test:handle_environment([{'decimal-formats', []},
{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/filter/filter005.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
'fn-filter-013'(_Config) ->
   ...
   Env = xqerl_test:handle_environment([{'decimal-formats', []},
{sources, [{"file:///C:/git/zadean/xquery-3.1/QT3-test-suite/fn/filter/fn-filter-012.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
