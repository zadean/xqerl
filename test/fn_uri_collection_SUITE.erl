...
'K2-SeqUriCollectionFunc-1'(_Config) ->
...
'K2-SeqUriCollectionFunc-2'(_Config) ->
   Qry = "uri-collection(\":/\")",
   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
   Res = try xqerl:run(Qry1) of D -> D catch _:E -> E end,
