...
, try  xqerl:compile("C:/git/xqerl/test/QT3_1_0/prod/CompNamespaceConstructor/cnc-module.xq") catch _:_ -> ok end,Config.
all() -> [
   'nscons-001',
   'nscons-002',
   'nscons-003',
...
[{sources, []},
{schemas, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/CompNamespaceConstructor/schema.xsd","http://www.w3.org/TestSchemas/cnc"}]},
{collections, []},
{'static-base-uri', []},
{params, []},
{namespaces, []},
...
'nscons-001'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e xmlns:saxon=\"http://saxon.sf.net/\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\" a=\"23\"/>"++"</x>)")) == "true" of
...
'nscons-003'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out><t:e xmlns:t=\"http://www.example.com/\" xmlns=\"http://saxon.sf.net/\"
...
'nscons-004'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out><t:e xmlns:t=\"http://www.example.com/\" xml:space=\"preserve\" a=\"23\"><f/></t:e></out>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-005'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<saxon:extension xmlns:saxon=\"http://saxon.sf.net/\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\" 
...
'nscons-010'(_Config) ->
   ...
   Exp = "
         <out>true true</out>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out>true true</out>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-012'(_Config) ->
   ...
   Exp = "
         <out><namespace 
              ...
              is-node=\"true\"/></out>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<out><namespace 
              same-as-self=\"true\" is-namespace=\"true\" namespace-uri=\"\" is-item=\"true\"
              typed-value=\"http://example.com/one\"
              is-untyped=\"false\"
              string-value=\"http://example.com/one\"
...
'nscons-013'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e xmlns:z=\"http://www.zorba-xquery.com/\"/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-015'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<z:e xmlns:z=\"http://www.zorba-xquery.com/\" xmlns=\"http://www.w3.org/\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-022'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<z:f xmlns:z=\"http://www.zorba-xquery.com/\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-031'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<inner xmlns:new=\"http://new.zorba-xquery.com/\" xmlns:out=\"http://out.zorba-xquery.com/\" xmlns:in=\"http://in.zorba-xquery.com/\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-032'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<inner xmlns:in=\"http://in.zorba-xquery.com/\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-033'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<inner xmlns:new=\"http://new.zorba-xquery.com/\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-034'(_Config) ->
   ...
   Exp = "
        <inner/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<inner/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-036'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<inner xmlns:in=\"http://in.zorba-xquery.com/\" xmlns:out=\"http://out.zorba-xquery.com/\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'nscons-039'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e0 xmlns:pre2=\"uri2\" xmlns:pre1=\"uri1\" />"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
