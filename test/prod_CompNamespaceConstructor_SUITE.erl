...
, try  xqerl:compile("C:/git/zadean/xqerl/test/QT3-test-suite/prod/CompNamespaceConstructor/cnc-module.xq") catch _:_ -> ok end,Config.
all() -> [
   'nscons-001',
   'nscons-002',
   'nscons-003',
...
[{'decimal-formats', []},
{sources, []},
{schemas, [{"C:/git/zadean/xqerl/test/QT3-test-suite/prod/CompNamespaceConstructor/schema.xsd","http://www.w3.org/TestSchemas/cnc"}]},
{collections, []},
