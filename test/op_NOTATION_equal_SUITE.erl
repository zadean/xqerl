...
[{'decimal-formats', []},
{sources, [{"file:///C:/git/zadean/xqerl/test/QT3-test-suite/op/NOTATION-equal/notation.xml",".",""}]},
{schemas, [{"NOTATION-equal/notationschema.xsd","http://www.example.com/notation"}]},
{collections, []},
