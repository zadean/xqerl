...
[{'decimal-formats', []},
{sources, [{"C:/git/zadean/xqerl/test/QT3-test-suite/op/NOTATION-equal/notation.xml",".",""}]},
{schemas, [{"C:/git/zadean/xqerl/test/QT3-test-suite/op/NOTATION-equal/notationschema.xsd","http://www.example.com/notation"}]},
{collections, []},
{'static-base-uri', [{"C:/git/zadean/xqerl/test/QT3-test-suite/op/"}]},
{params, []},
{vars, []},
{namespaces, []},
{resources, []},
