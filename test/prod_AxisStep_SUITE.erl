...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/Tree1Child.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/TreeEmpty.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/TreeRepeat.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/TreeStack.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/TreeTrunc.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
environment('TreeNS') ->
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/TreeNS.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/CPPGlobals.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/app/XMark/XMarkAuction.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
environment('xq311B') ->
[{sources, [{"file:///C:/git/xqerl/test/QT3_1_0/prod/AxisStep/xq311B.xml",".",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
'Axes085'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<root><Customers CustomerID=\"ALFKI\">
		<CompanyName>Alfreds Futterkiste</CompanyName>
		<ContactName>Maria Anders</ContactName>
		<ContactTitle>Sales Representative</ContactTitle>
		<Phone>030-0074321</Phone>
...
'Axes086'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<root><west mark=\"w0\" /><center mark=\"c0\">Text in center</center><east mark=\"e0\">Text in east</east></root>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'Axes087'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<root><retail>62.50 USD</retail><wholesale>55.00 USD</wholesale><internal>31.25 USD</internal></root>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'Axes117'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case    (xqerl_seq2:singleton_value(xqerl:run("declare variable $result external;"++"name($result) = \"xsl\"",Options)) == {xqAtomicValue,'xs:boolean',true}) andalso xqerl_seq2:size(Res) == 1 andalso xqerl_types:string_value(Res) == "http://www.w3.org/1999/XSL/Transform" andalso xqerl_types:type(Res) == 'namespace-node' of true -> {comment, "any-of"};
...
'K2-Axes-1'(_Config) ->
   ...
   Exp = "
         <f>f's value</f>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<f>f's value</f>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-24'(_Config) ->
   ...
   Exp = "
         <e>some text</e>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e>some text</e>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-26'(_Config) ->
   ...
   Exp = "
         <e attr=\"c\"/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e attr=\"c\"/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-27'(_Config) ->
   ...
   Exp = "
         <e><?name data?></e>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e><?name data?></e>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-28'(_Config) ->
   ...
   Exp = "
         <e><!--data --></e>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e><!--data --></e>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-57'(_Config) ->
   ...
   Exp = "
         <b/><c/><d/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<b/><c/><d/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-58'(_Config) ->
   ...
   Exp = "
         <b/><c/><d/><b/><c/><d/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<b/><c/><d/><b/><c/><d/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-59'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_types:string_value(Res) == "1 1") orelse (is_tuple(Res) andalso element(1,Res) == 'xqError' andalso element(4,element(2,Res)) == "XPST0005") of true -> {comment, "any-of"};
   Q -> ct:fail(['any-of', {Res,Exp,Q}]) end.
'K2-Axes-60'(_Config) ->
...
'K2-Axes-62'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<e><b attr=\"fo\"/><b/></e><b attr=\"fo\"/><b/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-64'(_Config) ->
   ...
   Exp = "
         <b/><b a=\"\"/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<b/><b a=\"\"/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-65'(_Config) ->
   ...
   Exp = "
         <b a=\"\"/><b/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<b a=\"\"/><b/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-66'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<!-- comment --><?PA ?>text<b/><?PB ?><b/><?PC ?>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-68'(_Config) ->
   ...
   Exp = "
         1<e/>1
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"1<e/>1"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-70'(_Config) ->
   ...
   Exp = "
         1<e attr=\"\"/>1
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"1<e attr=\"\"/>1"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-75'(_Config) ->
   ...
   Exp = "
         <a><b c=\"\"/><d/></a>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<a><b c=\"\"/><d/></a>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-76'(_Config) ->
   ...
   Exp = "
         <d/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<d/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
              case ResXml == "<d/>" of
                 true -> {comment, "assert-xml"};
...
'K2-Axes-86'(_Config) ->
   ...
   Exp = "
      ...
      ",
 case (xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P1 -> "deep-equal(<x>"++P1++"</x>" end ++ " , " ++ "<x>" ++ "<empty/>true"++ "</x>)" )) == "true" orelse ResXml == Exp) orelse (is_tuple(Res) andalso element(1,Res) == 'xqError' andalso element(4,element(2,Res)) == "XPST0005") of true -> {comment, "any-of"};
   Q -> ct:fail(['any-of', {Res,Exp,Q}]) end.
'K2-Axes-87'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<result><a>1</a><b>2</b></result>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-89'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<r xmlns=\"http://typedecl\" attr=\"foo\"/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'K2-Axes-102'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<name>Seongtaek Mattern</name><name>Seongtaek Mattern</name><name>Seongtaek Mattern</name>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'cbcl-selfAxis-001'(_Config) ->
   ...
   Exp = "
         <a b=\"blah\"/>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<a b=\"blah\"/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
...
'cbcl-wild-002'(_Config) ->
   ...
   Exp = "
      ...
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<foo:b xmlns:foo=\"http://localhost/\"/>"++"</x>)")) == "true" of
           true -> {comment, "assert-xml"};
           _ -> 
