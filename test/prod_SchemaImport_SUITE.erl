...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "../docs/emptydoc.xml"), ".",""}]},
{schemas, [{filename:join(BaseDir, "SchemaImport/abf.xsd"),"http://www.w3.org/XQueryTest/abf"}]},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "../docs/emptydoc.xml"), "$emptydoc1",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "../fn/nilled/validate.xml"), ".",""}]},
