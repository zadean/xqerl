...
'modules-simple'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/test1-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-1'(Config) ->
   ...
   Qry = "
      ...
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris1-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-3'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris2-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-4'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-urisi1-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-7'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris3-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-8'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris4-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-9'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris5-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-10'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris6-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-11'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris7-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-12'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris8-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-13'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris9-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-14'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris10-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-15'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris11-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-16'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris12-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-17'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris13-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-18'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris14-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-19'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris15-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-20'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris16-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-21'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris17-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-22'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris18-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-23'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris19-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-24'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris20-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'module-URIs-25'(Config) ->
   ...
   Qry = "
        ...
        <result>{test:ok()}</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-uris21-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-collide-var-001'(Config) ->
   ...
   Qry = "
        ...
        <result>{test1:ok()}</result>",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/test1-lib.xq")) catch _:_ -> ok end, 
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/test1collide1-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-collide-fn-001'(Config) ->
   ...
   Qry = "
      ...
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/test1-lib.xq")) catch _:_ -> ok end, 
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/test1collide2-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-emptyns'(Config) ->
   ...
   Qry = "
        ...
        <result>ok</result>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/emptyns-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-circular'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/test2c1-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-15'(Config) ->
   ...
   Qry = "
        ...
        \"aaa\"
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/test2-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-17'(Config) ->
   ...
   Qry = "
        ...
        \"abc\"
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/modulesdiffns-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-18'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module2-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-28a'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/modules-recursive2.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'errata8-001a'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/errata8-module1b.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'errata8-002a'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/errata8-module2b.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'errata8-003'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/errata8-module3b.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-pub-priv-1'(Config) ->
   ...
   Qry = "
        ...
        <a>{defs:g(42)}</a>
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-pub-priv.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-pub-priv-27'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-pub-priv3.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'modules-pub-priv-28'(Config) ->
   ...
   Qry = "
      ...
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-pub-priv.xq")) catch _:_ -> ok end, 
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/module-pub-priv2.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'cbcl-module-002'(Config) ->
   ...
   Qry = "
      ...
      ",
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/baseuri-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
...
'cbcl-module-003'(Config) ->
   ...
   try xqerl_module:compile(filename:join(BaseDir, "ModuleImport/variablereference-lib.xq")) catch _:_ -> ok end,   Qry1 = Qry,
   io:format("Qry1: ~p~n",[Qry1]),
