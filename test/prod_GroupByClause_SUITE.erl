...
[{'decimal-formats', []},
{sources, [{"file://"++filename:join(BaseDir, "GroupByClause/products.xml"), "$products-doc",""},
{"file://"++filename:join(BaseDir, "GroupByClause/sales-records.xml"), "$sales-records-doc",""},
{"file://"++filename:join(BaseDir, "GroupByClause/stores.xml"), "$stores-doc",""},
{"file://"++filename:join(BaseDir, "GroupByClause/books.xml"), "$books-doc",""}]},
{schemas, []},
{collections, []},
{'static-base-uri', []},
{params, []},
