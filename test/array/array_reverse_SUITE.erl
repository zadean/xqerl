...
'array-reverse-801'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "array-reverse-801.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'array-reverse-802'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "array-reverse-802.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'array-reverse-803'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "array-reverse-803.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
...
'array-reverse-804'(Config) ->
    ...
    Res =
        try
            Mod = xqerl_code_server:compile(filename:join(__BaseDir, "array-reverse-804.xq"), Qry1),
            xqerl:run(Mod, Opts)
        of
            D -> D
        catch
