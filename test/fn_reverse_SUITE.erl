...
'K2-SeqReverseFunc-1'(_Config) ->
   ...
   Exp = "
         <f/><a><b><c/><d/></b><e/></a>
      ",
   case catch xqerl_node:to_xml(xqerl_test:run(case xqerl_node:to_xml(Res) of {xqError,_,_,_,_} -> "deep-equal(<x></x>"; P -> "deep-equal(<x>"++P++"</x>" end ++ " , " ++ "<x>"++"<f/><a><b><c/><d/></b><e/></a>"++"</x>)")) == "true" of
